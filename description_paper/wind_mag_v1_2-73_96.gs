...
'd index.2'
*
label(205.0,98.0,"(b) Multiplicative factor for wind speed (1973-1997)",30,0,0.15)
...
*----------------------------------------------------
*
*'open wind_mag_annual.1973_1996.ctl'
*'set vpage 0.00 8.50 0.00 11.00'
...
'print'
'disable print'
'!gxeps -c -i wind_mag.gm -o wind_mag_v1_2-73_96.eps'
'!rm wind_mag.gm'
*====================================================
