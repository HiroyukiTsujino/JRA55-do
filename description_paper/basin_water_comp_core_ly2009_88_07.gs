...
'reinit'
*------------------------------------------------
'open basin_water-core-aug2017-ly2009.ctl'
'open basin_water-v0_1.ctl'
'open basin_water-v1_3.ctl'
*-----------------------------------------------
...
'set cthick 5'
'set cmark 0'
'd ave(glb.2,time=jan1988,time=jan2007)*1e-9'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(glb.3,time=jan1988,time=jan2007)*1e-9'
*
label(0.0,0.31,"GLOBAL Wtotal (1988-2007)",30,0,0.12)
label(-110,0.0,"[10^9 kg/s]",4,90,0.10)
label(0.0,-0.17,"latitude",30,0,0.12)
*
splt(0.0,0,180)
*---------------------------------------------------------------
*
...
'set cthick 5'
'set cmark 0'
'd ave(inp.2,time=jan1988,time=jan2007)*1e-9'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(inp.3,time=jan1988,time=jan2007)*1e-9'
*
label(0.0,0.31,"Indo-Pacific Wtotal (1988-2007)",30,0,0.12)
label(-110,0.0,"[10^9 kg/s]",4,90,0.10)
label(0.0,-0.17,"latitude",30,0,0.12)
*
splt(0.0,0,180)
...
'set cthick 5'
'set cmark 0'
'd ave(atl.2,time=jan1988,time=jan2007)*1e-9'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(atl.3,time=jan1988,time=jan2007)*1e-9'
*
label(0.0,0.31,"Arctic-Atlantic Wtotal (1988-2007)",30,0,0.12)
label(-110,0.0,"[10^9 kg/s]",4,90,0.10)
label(0.0,-0.17,"latitude",30,0,0.12)
*
splt(0.0,0,180)
...
*
'set line 3 1 5'
'run drawline.gs 8.0 0.28 32.0 0.28'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 36.0 0.28 CORE'
'set string 1 c 3'
*
'set line 4 1 5'
'run drawline.gs 8.0 0.26 32.0 0.26'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 36.0 0.26 JRA55-raw'
'set string 1 c 3'
*
'set line 2 1 5'
'run drawline.gs 8.0 0.24 32.0 0.24'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 36.0 0.24 JRA55-do'
'set string 1 c 3'
*---------------------------------------------------------------
'close 3'
'close 2'
...
'print'
'disable print'
'!gxeps -c -i water.gm -o basin_water_comp_core_ly2009_88_07.eps'
'!rm -f water.gm'
*==============================================================
