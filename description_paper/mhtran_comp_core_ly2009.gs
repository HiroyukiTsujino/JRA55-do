...
'reinit'
*------------------------------------------------
'open mhtrans-corely2009.ctl'
'open mhtrans-v0_1noadj.ctl'
'open mhtrans-v1_1noadj.ctl'
*
...
'set ylint 0.5'
*
'define glbadj=ave(-glb.4+glb.5+glb.6+glb.7,time=jan1948,time=jan2006)*1e-15'
'set ccolor 3'
'set cthick 5'
'set cmark 0'
*'d ave(glb.1,time=jan1984,time=jan2006)*1e-15 + glbadj'
'd ave(glb.1,time=jan1984,time=jan2006)*1e-15'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(glb.2,time=jan1984,time=jan2006)*1e-15 + glbadj'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
'd ave(glb.3,time=jan1984,time=jan2006)*1e-15 + glbadj'
label(0.0,2.65,"GLOBAL MHT (1984-2006)",30,0,0.12)
...
'set ylint 0.5'
*
'define inpadj=ave(-inp.4+inp.5+inp.6+inp.7,time=jan1948,time=jan2006)*1e-15'
'set ccolor 3'
'set cthick 5'
'set cmark 0'
*'d ave(inp.1,time=jan1984,time=jan2006)*1e-15 + inpadj'
'd ave(inp.1,time=jan1984,time=jan2006)*1e-15'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(inp.2,time=jan1984,time=jan2006)*1e-15 + inpadj'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
'd ave(inp.3,time=jan1984,time=jan2006)*1e-15 + inpadj'
label(0.0,2.65,"Indo-Pacific MHT (1984-2006)",30,0,0.12)
label(-110,0.0,"[PW]",4,90,0.10)
label(0.0,-2.2,"latitude",30,0,0.12)
*
splt(0.0,0,180)
...
'set ylint 0.5'
*
'define atladj=ave(-atl.4+atl.5+atl.6+atl.7,time=jan1948,time=jan2006)*1e-15'
'set ccolor 3'
'set cthick 5'
'set cmark 0'
*'d ave(atl.1,time=jan1984,time=jan2006)*1e-15 + atladj'
'd ave(atl.1,time=jan1984,time=jan2006)*1e-15'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(atl.2,time=jan1984,time=jan2006)*1e-15 + atladj'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
'd ave(atl.3,time=jan1984,time=jan2006)*1e-15 + atladj'
label(0.0,2.65,"Arctic-Atlantic MHT (1984-2006)",30,0,0.12)
label(-110,0.0,"[PW]",4,90,0.10)
label(0.0,-2.2,"latitude",30,0,0.12)
*
splt(0.0,0,180)
...
'print'
'disable print'
'!gxeps -c -i dswrf.gm -o mht_comp_core_ly2009.eps'
'!rm -f dswrf.gm'
*==============================================================
