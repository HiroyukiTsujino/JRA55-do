...
'open jra55_v1_3_tauy_pac_zm_mon_TL319.ctl'
'open jra55_v1_4_prod4_tauy_pac_zm_mon_TL319.ctl'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
...
* line legend
'set line 1 1 5'
'run drawline.gs 0.03 10.0 0.05 10.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.053 10.0 SCOW'
'set string 1 c 3'
*
'set line 4 1 5'
'run drawline.gs 0.03 0.0 0.05 0.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.053 00.0 JRA55-do-v1.3'
'set string 1 c 3'
*
'set line 2 1 5'
'run drawline.gs 0.03 -10.0 0.05 -10.0'
...
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.053 -10.0 JRA55-do-v1.4'
'set string 1 c 3'

'set line 14 1 5'
'run drawline.gs 0.03 -20.0 0.05 -20.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.053 -20.0 v1.4-v1.3'
'set string 1 c 3'
*
*
*'close 3'
...
'open jra55_v1_3_tauy_atl_zm_mon_TL319.ctl'
'open jra55_v1_4_prod4_tauy_atl_zm_mon_TL319.ctl'
*
'set lat -40 75'
'set xyrev on'
'set xlint 0.02'
...
'open jra55_v1_3_tauy_so_zm_mon_TL319.ctl'
'open jra55_v1_4_prod4_tauy_so_zm_mon_TL319.ctl'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
...
'print'
'disable print'
'!gxeps -c -i tau_comp.gm -o tauy_comp_pac_atl_scow_v1_4_prod4.eps'
'!\rm tau_comp.gm'
*====================================================
