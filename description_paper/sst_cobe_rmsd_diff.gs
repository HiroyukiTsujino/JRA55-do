...
'reinit'
*-----------------------------------
'open sst_rmsd_from_moncl_cobesst.1981_2010.ctl'
'open sst_rmsd_from_moncl_hurrellsst.1981_2010.ctl'
...
'd index.3'
*
 label(205.0,98.0,"RMSD from monthly climatology (COBESST 1981-2010)",50,0,0.15)
*'draw string 8.0 1.25 [cm]'
'run cbarn2.gs 0.85 0 4.25 6.0 1 2'
*
'set strsiz 0.1'
'set string 1 c 3'
'draw string 7.5 5.8 [degC]'
'run drawstring.gs 70.0 50.0 CI=0.2(degC)'
*
*----------------------------------------------------
'set vpage 0.00 8.50 0.00 11.00'
...
'set strsiz 0.1'
'set string 1 c 3'
'draw string 7.5 0.55 [degC]'
'run cbarn2.gs 0.85 0 4.25 0.75 2 5'
'set string 1 c 3'
'run drawstring.gs 70.0 50.0 CI=0.1(degC)'
*
'close 3'
'close 2'
'close 1'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o sst_cobe_rmsd_diff.eps'
'!rm -f hflux.gm'
*====================================================
