...
'open tmp10m_v1_3_prod4_monthly.ctl'
...
'd index.4'
*
label(0.0,24.0,"(a) T10m change by CORE",30,0,0.15)
label(0.0,31.0,"FEB 1958-78, CI=1(K)",15,0,0.15)
...
'd index.4'
*
label(180.0,-32.0,"(b) T10m change by CORE",30,0,0.15)
label(180.0,-39.0,"AUG 1958-78, CI=1(K)",15,0,0.15)
'run cbarn2.gs 0.8 0 5.5 1.0 3 4'
*
'close 4'
'close 3'
'close 2'
...
'print'
'disable print'
'!gxeps -c -i tmp2m_corr.gm -o tmp10m_corr_v1_3-p4-p3.eps'
'!rm tmp2m_corr.gm'
*====================================================
