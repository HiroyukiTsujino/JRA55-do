...
'set gxout shaded'
'run colmap.gs rbb64'
'run clevsreg.gs -93 93 3'
'set grads off'
'd smth9(ave(-evapor.1,time=jan1988,time=jan2007))*1e6'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'set cthick 2'
'd smth9(ave(-evapor.1,time=jan1988,time=jan2007))*1e6'
 label(205.0,98.0,"Evaporation JRA55-do (1988-2007)",30,0,0.15)
'set strsiz 0.08'
...
'set gxout shaded'
'run colmap.gs rb26'
'run clevsreg.gs -24 24 2'
'set grads off'
'd smth9(ave(-evapor.1+evapor.2,time=jan1988,time=jan2007))*1e6'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'print'
'disable print'
'!gxeps -c -i wflux.gm -o evapor_diff.eps'
'!rm -f wflux.gm'
*====================================================
