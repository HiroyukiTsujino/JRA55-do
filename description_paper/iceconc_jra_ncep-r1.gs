...
*
'set gxout shaded'
'run colmap.gs odcm2n'
'run clevsreg.gs 0.05 1.0 0.05'
'set grads off'
'd ave(icecsfc,time=feb1958,time=dec1978,12)*index.2'
*
*'set gxout contour'
*'set ccolor 1'
*'set clab off'
...
*'set cthick 1'
*'set grads off'
*'d ave(tmp10m.2-tmp10m.1,time=feb1958,time=dec1978,12)*index.2'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
*
label(0.0,24.0,"(a) Sea-Ice concentration of JRA-55",30,0,0.12)
label(0.0,31.0,"FEB 1958-78",15,0,0.12)
'query w2xy 320.0 55.0'
x = subwrd(result,3)
y = subwrd(result,6)
'set strsiz 0.11'
'set string 1 c 3 0'
'draw string ' x ' ' y ' X '
'set line 1 1 3'
'query w2xy 319.0 58.0'
x1 = subwrd(result,3)
y1 = subwrd(result,6)
'query w2xy 308.0 61.0'
x2 = subwrd(result,3)
y2 = subwrd(result,6)
'draw line ' x1 ' ' y1 ' ' x2 ' ' y2
'set line 1 1 3'
*
'query w2xy 313.0 45.0'
x = subwrd(result,3)
y = subwrd(result,6)
'set strsiz 0.11'
'draw string ' x ' ' y ' Y '
'set string 1 c 3 0'
'set line 1 1 3'
'query w2xy 311.0 48.0'
x1 = subwrd(result,3)
y1 = subwrd(result,6)
'query w2xy 305.0 51.0'
x2 = subwrd(result,3)
y2 = subwrd(result,6)
'draw line ' x1 ' ' y1 ' ' x2 ' ' y2
'set line 1 1 3'
*'run cbarn2.gs 0.8 0 4.25 0.5 3 4'
*
'close 3'
'close 2'
'close 1'
*------------------------------------------------
'sdfopen /denkei-shared/og1/htsujino/NCEP_R1/rawdata/icec.sfc.mon.mean.nc'
'open lsmask.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 4.5 8.0 6.0 10.5'
*
'set lat 38 90'
*'set xlint 30'
*'set ylint 20'
...
'run clevsreg.gs 0.05 1.0 0.05'
'set grads off'
'd ave(icec,time=feb1958,time=dec1978,12)'
*
*'set gxout contour'
*'set ccolor 1'
*'set clab off'
...
*'set cthick 1'
*'set grads off'
*'d ave(tmp10m_org,time=jan1979,time=dec1998)'
*
*'set gxout contour'
*'set ccolor 1'
*'set clab off'
...
*'set cthick 1'
*'set grads off'
*'d ave(tmp10m.2-tmp10m.1,time=aug1979,time=dec1998,12)*index.3'
*
'set gxout fgrid'
'set fgvals 0 15'
'd lsmask.2'
*
label(0.0,24.0,"(b) Sea-Ice concentration NCEP-R1 ",30,0,0.12)
label(0.0,31.0,"FEB 1958-78",15,0,0.12)
*'run cbarn2.gs 0.8 0 4.25 1.0 3 4'
*
'query w2xy 150.0 50.0'
x = subwrd(result,3)
y = subwrd(result,6)
'set strsiz 0.11'
'draw string ' x ' ' y ' Z '
...
'run clevsreg.gs 0.05 1.0 0.05'
'set grads off'
'd ave(icecsfc,time=feb1978,time=dec1998,12)*index.2'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
*
label(0.0,24.0,"(c) Sea-Ice concentration of JRA-55",30,0,0.12)
label(0.0,31.0,"FEB 1979-98",15,0,0.12)
*'run cbarn2.gs 0.8 0 4.25 0.5 3 4'
*
'close 3'
'close 2'
...
'run clevsreg.gs 0.05 1.0 0.05'
'set grads off'
'd ave(icec,time=feb1979,time=dec1998,12)'
*'d ave(icec,time=feb1979,time=dec1998,12)*index.3'
*
*'set gxout contour'
*'set ccolor 1'
*'set clab off'
...
'd lsmask.2'
*
label(0.0,24.0,"(d) Sea-Ice concentration NCEP-R1 ",30,0,0.12)
label(0.0,31.0,"FEB 1979-98",15,0,0.12)
'run cbarn2.gs 0.8 0 4.25 1.2 3 4'
*
'close 2'
'close 1'
*----------------------------------------------------
'enable print ice_comp.gm'
'print'
'disable print'
'!gxeps -c -i ice_comp.gm -o ice_comp.eps'
'!rm ice_comp.gm'
*====================================================
