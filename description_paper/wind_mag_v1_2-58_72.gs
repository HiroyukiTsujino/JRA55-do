...
'd index.2'
*
label(205.0,98.0,"(a) Multiplicative factor for wind speed (1958-1972)",30,0,0.15)
...
*----------------------------------------------------
*
*'open wind_mag_annual.1958_1972.ctl'
*'set vpage 0.00 8.50 0.00 11.00'
...
'print'
'disable print'
'!gxeps -c -i wind_mag.gm -o wind_mag_v1_2-58_72.eps'
'!rm wind_mag.gm'
*====================================================
