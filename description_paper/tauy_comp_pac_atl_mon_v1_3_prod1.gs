...
'open jra55_v1_3_prod1_tauy_pac_zm_mon_TL319.ctl'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
...
'open jra55_v1_3_prod1_tauy_atl_zm_mon_TL319.ctl'
*
'set lat -40 75'
'set xyrev on'
'set xlint 0.02'
...
'open jra55_v1_3_prod1_tauy_so_zm_mon_TL319.ctl'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
...
'print'
'disable print'
'!gxeps -c -i tau_comp.gm -o tauy_comp_pac_atl_scow_v1_3_prod1.eps'
'!\rm tau_comp.gm'
*====================================================
