...
'reinit'
*------------------------------------------------
'open wind_mag_annual_v1_2.1958_1972.ctl'
...
'd index.3'
*
label(205.0,98.0,"(a) Multiplicative factor for wind speed (1958-1972)",30,0,0.135)
'set string 1 c 3'
...
'close 1'
*----------------------------------------------------
'open wind_mag_annual_v1_2.1973_1996.ctl'
'open jra55_ocean_mask_undef0.ctl'
'open jra55_ocean_mask.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
'd index.3'
*
label(205.0,98.0,"(b) Multiplicative factor for wind speed (1973-1997)",30,0,0.135)
*'run cbarn2.gs 0.8 0 4.25 6.0 1 2'
'set string 1 c 3'
'run drawstring.gs 70.0 50.0 CI=0.1'
*
...
'd index.3'
*
label(205.0,98.0,"(c) Multiplicative factor for wind speed (1998-present)",30,0,0.135)
'set string 1 c 3'
'run drawstring.gs 70.0 50.0 CI=0.1'
*'run cbarn2.gs 0.8 0 4.25 6.0 1 2'
...
'print'
'disable print'
'!gxeps -c -i wind_mag.gm -o wind_mag_v1_2-all.eps'
'!rm wind_mag.gm'
*====================================================
