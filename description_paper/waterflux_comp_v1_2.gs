...
'd f.3*3.654e5'
*
label(34,15.2,"(a) Evaporation",30,0,0.12)
...
label(34,14.05,"(b) Precipitation",30,0,0.12)
*label(-5,0,"[Sv]",4,90,0.12)
label(-6,13.2,"10^9 [kg/sec]",4,90,0.12)
...
'print'
'disable print'
'!gxeps -c -i waterflux.gm -o waterflux_jra55_v1_2.eps'
'!rm -f waterflux.gm'
*====================================================
