...
'reinit'
*------------------------------------------------
'open nswrf_glb_v1_3.ctl'
'open nlwrf_glb_v1_3.ctl'
'open latent_glb_v1_3.ctl'
'open sensible_glb_v1_3.ctl'
*
...
*
'open nswrf_glb_core_aug2017.ctl'
'open nlwrf_glb_core_aug2017.ctl'
'open latent_glb_core_aug2017.ctl'
'open sensible_glb_core_aug2017.ctl'
*
*'open nswrf_glb_v1_3_hurrell.ctl'
*'open nlwrf_glb_v1_3_hurrell.ctl'
*'open latent_glb_v1_3_hurrell.ctl'
*'open sensible_glb_v1_3_hurrell.ctl'
*
...
* line legend
'set line 4 1 10'
'run drawline_gr2xy.gs 3 174.0 8 174.0'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 9 174.0 JRA55-raw'
'set string 1 c 3'
*
'set line 2 1 10'
'run drawline_gr2xy.gs 26 174.0 31 174.0'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 32 174.0 JRA55-do'
'set string 1 c 3'
*
'set line 3 1 10'
'run drawline_gr2xy.gs 49 174.0 54 174.0'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 55 174.0 CORE'
'set string 1 c 3'
*
*'set line 15 1 10'
*'run drawline_gr2xy.gs 26 172.5 31 172.5'
*'set line 1 1 1'
*'set string 1 l 3'
*'run drawstring_gr2xy.gs 32 172.5 JRA55-do+HurrellSST'
*'set string 1 c 3'
*
label(34,176.5,"(a) Net shortwave",30,0,0.12)
label(-7,167.5,"[W/m2]",4,90,0.10)
...
'd f.10'
*
label(34,-44,"(b) Net longwave",30,0,0.12)
label(-7,-52.5,"[W/m2]",4,90,0.10)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 11.0 0.0 8.5'
...
'd f.11'
*
label(34,-85,"(c) Latent heat flux",30,0,0.12)
label(-7,-94.5,"[W/m2]",4,90,0.10)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 11.0 0.0 8.5'
...
'd f.12'
*
label(34,-11.3,"(d) Sensible heat flux",30,0,0.12)
label(-7,-15,"[W/m2]",4,90,0.10)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 11.0 0.0 8.5'
'set parea 6.25 10.75 1.0 5.0'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.08'
'set ylopts 1 3 0.12'
...
splt(0.0,1,69)
*
label(34,12.0,"(e) TOTAL surface heat flux",30,0,0.12)
label(-7,3.0,"[W/m2]",4,90,0.10)
label(34,-7,"[Year]",30,0,0.11)
*
*'close 16'
*'close 15'
*'close 14'
...
'close 1'
*----------------------------------------------------
'printim figs/heatflux_jra55_v1_3_rev1.png white'
*'enable print heatflux.gm'
*'print'
*'disable print'
*'!gxeps -c -i heatflux.gm -o heatflux_jra55_v1_3_rev1.eps'
*'!rm -f heatflux.gm'
*====================================================
