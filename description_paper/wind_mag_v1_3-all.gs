...
'reinit'
*------------------------------------------------
'open wind_mag_offset_annual.1958_1972.ctl'
...
'd index.3'
*
label(205.0,98.0,"(a) Offset factor for wind speed (1958-1972)",30,0,0.135)
'set string 1 c 3'
'run drawstring.gs 75.0 55.0 CI=0.5(m/s)'
...
'close 1'
*----------------------------------------------------
'open wind_mag_offset_annual.1973_1996.ctl'
'open jra55_ocean_mask_undef0.ctl'
'open jra55_ocean_mask.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
'd index.3'
*
label(205.0,98.0,"(b) Offset factor for wind speed (1973-1997)",30,0,0.135)
*'run cbarn2.gs 0.8 0 4.25 6.0 1 2'
'set string 1 c 3'
'run drawstring.gs 75.0 55.0 CI=0.5(m/s)'
*
...
'd index.3'
*
label(205.0,98.0,"(c) Offset factor for wind speed (1998-present)",30,0,0.135)
'set string 1 c 3'
'run drawstring.gs 75.0 55.0 CI=0.5(m/s)'
*'run cbarn2.gs 0.8 0 4.25 6.0 1 2'
'run cbarn2.gs 0.7 -1 7.5 5.25 1 2'
*
'close 3'
'close 2'
'close 1'
...
'print'
'disable print'
'!gxeps -c -i wind_mag.gm -o wind_mag_v1_3-all.eps'
'!rm wind_mag.gm'
*====================================================
