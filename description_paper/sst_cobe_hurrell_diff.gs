...
'reinit'
*-----------------------------------
'open sst_vs_hurrell.1981-2010.ctl'
...
'd ave(t.2,t=1,t=12)'
*
 label(205.0,98.0,"(a) Mean difference COBESST - HurrellSST (1981-2010)",30,0,0.15)
*'draw string 8.0 1.25 [cm]'
*'run cbarn2.gs 0.85 0 4.25 0.5 0 10'
'run cbarn2.gs 0.85 0 4.25 6.0 1 10'
'set strsiz 0.12'
'set string 1 c 3' 
'draw string 7.5 5.85 [K]'
'set strsiz 0.1'
*'close 1'
*----------------------------------------------------
*
...
'set gxout shaded'
'run colmap.gs odcm3'
'run clevsreg.gs 0.05 1.50 0.05'
'set grads off'
'd rmsd'
*
'set gxout fgrid'
...
'set cthick 1'
'd rmsd'
 label(205.0,98.0,"(b) RMSD COBESST - HurrellSST (1981-2010)",30,0,0.15)
'set strsiz 0.12'
'set string 1 c 3' 
'draw string 7.5 0.55 [K]'
'set strsiz 0.1'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o sst_diff.eps'
'!rm -f hflux.gm'
*====================================================
