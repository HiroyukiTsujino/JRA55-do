...
'reinit'
*------------------------------------------------
'open tmp10m_v1_3_prod2_monthly.ctl'
'open tmp10m_v1_3_prod3_monthly.ctl'
...
'close 1'
*------------------------------------------------
'open sph10m_v1_3_prod2_monthly.ctl'
'open sph10m_v1_3_prod3_monthly.ctl'
'open jra55_ocean_mask_undef0.ctl'
'open jra55_ocean_mask.ctl'
*
'set vpage 0.00 11.00 0.00 8.50'
...
'print'
'disable print'
'!gxeps -c -i tmp2m_corr.gm -o tq10m_corr_v1_3-p3-p2.eps'
'!rm tmp2m_corr.gm'
*====================================================
