...
'reinit'
*------------------------------------------------
'open tmp10m_v0_7_prod2_monthly.ctl'
'open tmp10m_v0_7_prod3_monthly.ctl'
...
label(180.0,-40.0,"AUG 1958-78",15,0,0.15)
'run cbarn2.gs 0.5 0 3.0 1.0 1 4'
*
'close 3'
'close 2'
'close 1'
*------------------------------------------------
'open sph10m_v0_7_prod2_monthly.ctl'
'open sph10m_v0_7_prod3_monthly.ctl'
'open jra55_ocean_mask.ctl'
*
'set vpage 0.00 11.00 0.00 8.50'
...
'print'
'disable print'
'!gxeps -c -i tmp2m_corr.gm -o tq10m_corr_v0_7-p3-p2.eps'
'!rm tmp2m_corr.gm'
*====================================================
