...
'reinit'
*-----------------------------------
'open jra55_v1_2_nswrf.ctl'
'open jra55_v1_2_nlwrf.ctl'
'open jra55_v1_2_latent.ctl'
'open jra55_v1_2_sensible.ctl'
'open core_aug2017_nswrf.ctl'
'open core_aug2017_nlwrf.ctl'
'open core_aug2017_latent.ctl'
'open core_aug2017_sensible.ctl'
'open jra_cobe_ocean-mask.ctl'
*
...
'set gxout shaded'
'run colmap.gs rbb64'
'run clevsreg.gs -155 155 5'
'set grads off'
'd ave(nswrf.1+nlwrf.2+latent.3+sensible.4,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.9'
...
'set cthick 2'
'd ave(nswrf.1+nlwrf.2+latent.3+sensible.4,time=jan1988,time=jan2007)'
 label(205.0,98.0,"Total heat flux JRA55-do (1988-2007)",30,0,0.15)
*'draw string 8.0 1.25 [cm]'
'run cbarn2.gs 0.85 0 4.25 6.0 1 10'
*
*----------------------------------------------------
'set vpage 0.00 8.50 0.00 11.00'
'set parea 1.00 8.00 1.25 5.25'
*
'set lon 25 385'
'set xlint 30'
'set ylint 20'
...
'set gxout shaded'
'run colmap.gs rb26'
'run clevsreg.gs -48 48 4'
'set grads off'
'd ave(nswrf.1+nlwrf.2+latent.3+sensible.4-nswrf.5-nlwrf.6-latent.7-sensible.8,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.9'
...
'set cthick 2'
'd ave(nswrf.1+nlwrf.2+latent.3+sensible.4-nswrf.5-nlwrf.6-latent.7-sensible.8,time=jan1988,time=jan2007)'
 label(205.0,98.0,"JRA55-do - CORE (1988-2007)",30,0,0.15)
*
'set strsiz 0.08'
'draw string 8.0 0.5 [W/m2]'
'set strsiz 0.1'
'run cbarn2.gs 0.85 0 4.25 0.75 2 5'
*
'close 9'
'close 8'
'close 7'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o hflux_total_diff.eps'
'!rm -f hflux.gm'
*====================================================
