...
*'close 1'
*
*'open jra55_v0_1_taux_pac_zm_mon_TL319.ctl'
'open jra55_v1_3_taux_pac_zm_mon_TL319.ctl'
'open jra55_v1_4_prod4_taux_pac_zm_mon_TL319.ctl'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
...
'set cthick 5'
'set cmark 0'
'd ave(f.2-f.1,time=nov1999,time=oct2009)'
*
splt2(0.0,-40,75)
label(0.0,80.0,"(a) Zonal wind stress (Pacific)",25,0,0.12)
...
* line legend
'set line 1 1 5'
'run drawline.gs 0.04 10.0 0.055 10.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.058 10.0 SCOW'
'set string 1 c 3'
*
*'set line 3 1 5'
...
*
'set line 4 1 5'
'run drawline.gs 0.04 0.0 0.055 0.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.058 0.0 JRA55-do-v1.3'
'set string 1 c 3'
*
'set line 2 1 5'
'run drawline.gs 0.04 -10.0 0.055 -10.0'
...
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.058 -10.0 JRA55-do-v1.4'
'set string 1 c 3'
*
'set line 14 1 5'
'run drawline.gs 0.04 -20.0 0.055 -20.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.058 -20.0 v1.4-v1.3'
'set string 1 c 3'
*
*
*'close 3'
...
*
*
*'open jra55_v0_1_taux_atl_zm_mon_TL319.ctl'
'open jra55_v1_3_taux_atl_zm_mon_TL319.ctl'
'open jra55_v1_4_prod4_taux_atl_zm_mon_TL319.ctl'
*
'set lat -40 75'
'set xyrev on'
'set xlint 0.02'
...
*
splt2(0.0,-40,75)
label(0.0,80.0,"(b) Zonal wind stress (Atlantic)",25,0,0.12)
*label(-7,7.35,"[m/s]",4,90,0.11)
*label(34,6.95,"[Year]",30,0,0.12)
*
*
...
*'close 1'
*
*'open jra55_v0_1_taux_so_zm_mon_TL319.ctl'
'open jra55_v1_3_taux_so_zm_mon_TL319.ctl'
'open jra55_v1_4_prod4_taux_so_zm_mon_TL319.ctl'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
...
*
splt2(0.0,-80,-28)
label(0.075,-24.0,"(c) Zonal wind stress (Southern Ocean)",40,0,0.12)
*label(-7,7.35,"[m/s]",4,90,0.11)
*label(34,6.95,"[Year]",30,0,0.12)
*
*
...
'print'
'disable print'
'!gxeps -c -i tau_comp.gm -o taux_comp_pac_atl_scow_v1_4_prod4.eps'
'!\rm tau_comp.gm'
*====================================================
