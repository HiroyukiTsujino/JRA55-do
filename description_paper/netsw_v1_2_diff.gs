...
'set gxout shaded'
'run colmap.gs rbb64'
'run clevsreg.gs -310 310 10'
'set grads off'
'd ave(nswrf.1,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'set cthick 2'
'd ave(nswrf.1,time=jan1988,time=jan2007)'
 label(205.0,98.0,"Net short wave JRA55-do (1988-2007)",30,0,0.15)
...
'set grads off'
'd ave(nswrf.1-nswrf.2,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o netsw_diff.eps'
'!rm -f hflux.gm'
*====================================================
