...
'set grads off'
'd ave(dswrfcorr,t=1,t=12)*index.2'
*'set gxout contour'
*'set ccolor 1'
*'set clab on'
*'set cint 0.1'
...
*'draw string 8.0 1.25 [cm]'
 label(205.0,98.0,"(a) SW multiplicative factor (1958-1972)",30,0,0.135)
...
*
*'draw string 8.0 1.25 [cm]'
 label(205.0,98.0,"(b) SW multiplicative factor (1973-present)",30,0,0.135)
'run cbarn2.gs 0.5 0 2.75 0.5 1 2'
*
'close 3'
'close 2'
'close 1'
*----------------------------------------------------
'open dlwrf_corr.1958_1972.ctl'
'open jra55_ocean_mask_undef0.ctl'
'open jra55_ocean_mask.ctl'
*
'set vpage 0.00 11.00 0.00 8.50'
...
*'run clevsreg.gs 0.66 1.24 0.02'
'run colmap.gs factor20'
'set clevs 0.775 0.800 0.825 0.850 0.875 0.900 0.925 0.95 0.975 1.00 1.05 1.10 1.15 1.20 1.25 1.30 1.35 1.40 1.45'
'set grads off'
'd ave(dlwrfcorr,t=1,t=12)*index.2'
*--
*'set gxout contour'
*'set ccolor 1'
*'set clab on'
...
*
*---
 label(205.0,98.0,"(c) LW multiplicative factor (1958-1972)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 0.75 1 2'
*
'close 3'
'close 2'
...
'd index.3'
*
 label(205.0,98.0,"(d) LW multiplicative factor (1973-present)",30,0,0.135)
'run cbarn2.gs 0.5 0 8.25 0.5 1 2'
*
'close 3'
'close 2'
'close 1'
...
'print'
'disable print'
'!gxeps -c -i dswrf.gm -o dswrf_dlwrf_corr.eps'
'!rm -f dswrf.gm'
*====================================================
