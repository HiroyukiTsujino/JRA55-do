...
'open dswrf_all_glb_jra55c_v0_1.ctl'
'open dswrf_all_glb_core_jan2017.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 6.5 10.0'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.3'
*
label(34,195.2,"(a) Downward short wave",30,0,0.14)
...
* line legend
'set line 4 1 10'
'run drawline_gr2xy.gs 3 193.0 8 193.0'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 9 193.0 JRA-55'
'set string 1 c 3'
*
'set line 6 1 10'
'run drawline_gr2xy.gs 19 193.0 24 193.0'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 25 193.0 JRA-55C'
'set string 1 c 3'
*
'set line 3 1 10'
'run drawline_gr2xy.gs 37 193.0 42 193.0'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 43 193.0 CORE'
'set string 1 c 3'
*----------------------------------------------------
*
'open precip_glb_v0_1.ctl'
'open precip_glb_jra55c_v0_1.ctl'
'open precip_glb_core_jan2017.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 2.0  5.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.3*3.654e5'
*
label(34,17.1,"(b) Precipitation",20,0,0.14)
label(-6,14.5,"10^9 [kg/sec]",10,90,0.12)
label(34,11.7,"[Year]",6,0,0.12)
*
*--------------
* line legend
'set line 4 1 10'
'run drawline_gr2xy.gs 3 16.4 8 16.4'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 9 16.4 JRA-55'
'set string 1 c 3'
*
'set line 6 1 10'
'run drawline_gr2xy.gs 19 16.4 24 16.4'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 25 16.4 JRA-55C'
'set string 1 c 3'
*
'set line 3 1 10'
'run drawline_gr2xy.gs 37 16.4 42 16.4'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 43 16.4 CORE'
'set string 1 c 3'
*
'close 3'
'close 2'
...
*
*----------------------------------------------------
'enable print compflux.gm'
'print'
'disable print'
'!gxeps -c -i compflux.gm -o compare_dswrf_precip_raw.eps'
'!rm -f compflux.gm'
*====================================================
