...
'reinit'
*------------------------------------------------
'open nswrf_glb_v1_2.ctl'
'open nlwrf_glb_v1_2.ctl'
'open latent_glb_v1_2.ctl'
'open sensible_glb_v1_2.ctl'
*
...
* line legend
'set line 4 1 10'
'run drawline_gr2xy.gs 3 173.5 8 173.5'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 9 173.5 JRA55-raw'
'set string 1 c 3'
*
'set line 2 1 10'
'run drawline_gr2xy.gs 26 173.5 31 173.5'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 32 173.5 JRA55-do'
'set string 1 c 3'
*
'set line 3 1 10'
'run drawline_gr2xy.gs 49 173.5 54 173.5'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 55 173.5 CORE'
'set string 1 c 3'
*
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o heatflux_jra55_v1_2.eps'
'!rm -f heatflux.gm'
*====================================================
