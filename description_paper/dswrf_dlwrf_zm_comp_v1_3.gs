...
'reinit'
*------------------------------------------------
'open dswrf_all_zm_v0_1.ctl'
'open dswrf_all_zm_core.ctl'
'open dswrf_all_zm_v1_3.ctl'
'open swdn_seaice_tropics_filter_zm.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.0 8.0 5.75 10.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.14'
'set ylopts 1 3 0.12'
...
'set cthick 10'
'set cmark 0'
'd ave(f.4,time=mar2000,time=feb2009)'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
'd ave(f.1,time=mar2000,time=feb2009)'
'set ccolor 3'
'set cthick 5'
'set cmark 0'
'd ave(f.2,time=mar2000,time=feb2009)'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(f.3,time=mar2000,time=feb2009)'
label(0,272,"(a) Downward shortwave radiation (Mar2000-Feb2009)",30,0,0.13)
label(-105,167.5,"[W/m2]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*
* line legend
'set line 1 1 5'
'run drawline.gs -80.0 255.0 -65.0 255.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 255.0 CERES-adjusted'
'set string 1 c 3'
*
'set line 3 1 5'
'run drawline.gs -80.0 247.0 -65.0 247.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 247.0 CORE'
'set string 1 c 3'
*
'set line 4 1 5'
'run drawline.gs -80.0 239.0 -65.0 239.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 239.0 JRA55-raw'
'set string 1 c 3'
*
'set line 2 1 5'
'run drawline.gs -80.0 231.0 -65.0 231.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 231.0 JRA55-do'
'set string 1 c 3'
*
'close 4'
'close 3'
...
'close 1'
*-----------------------------------
'open dlwrf_all_zm_v0_1.ctl'
'open dlwrf_all_zm_core.ctl'
'open dlwrf_all_zm_v1_3.ctl'
'open lwdn_filter_zm.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.0 8.0 0.5 5.0'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.14'
...
'set cmark 0'
'd ave(f.3,time=mar2000,time=feb2009)'
label(0,465,"(b) Downward longwave radiation (Mar2000-Feb2009)",30,0,0.13)
label(-105,310,"[W/m2]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*-----------------------------------------
* line legend
'set line 1 1 5'
'run drawline.gs -80.0 430.0 -65.0 430.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 430.0 CERES'
'set string 1 c 3'
*
'set line 3 1 5'
'run drawline.gs -80.0 418.0 -65.0 418.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 418.0 CORE'
'set string 1 c 3'
*
'set line 4 1 5'
'run drawline.gs -80.0 406.0 -65.0 406.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 406.0 JRA55-raw'
'set string 1 c 3'
*
'set line 2 1 5'
'run drawline.gs -80.0 394.0 -65.0 394.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 394.0 JRA55-do'
'set string 1 c 3'
*
'close 4'
'close 3'
...
'print'
'disable print'
'!gxeps -c -i dswrf.gm -o dswrf_dlwrf_zm_comp.eps'
'!rm -f dswrf.gm'
*====================================================
