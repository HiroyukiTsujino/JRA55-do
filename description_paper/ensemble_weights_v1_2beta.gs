...
'run colmap.gs odcm2b'
'run clevsreg.gs 0.05 1.00 0.05'
'set grads off'
'd index'
*
*'set gxout contour'
...
*'set cthick 3'
*'set grads off'
*'d ave(corr_sph,t=1,t=12)'
*
label(205.0,98.0,"Additional weighting factor for low-res reanalysis (v1_2beta)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i sph2m_corr.gm -o ensemble_weights_v1_2beta.eps'
'!rm sph2m_corr.gm'
*====================================================
