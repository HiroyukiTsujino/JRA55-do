...
'open sph10m_v1_2_prod4_monthly.ctl'
*
...
'd ave(spfh10m.2-spfh10m.1,time=feb1958,time=dec1978,12)*1000'
*
label(0.0,32.0,"(a) Q10m change by CORE (v1_2)",30,0,0.15)
...
'd ave(spfh10m.2-spfh10m.1,time=aug1958,time=dec1978,12)*1000'
*
label(180.0,-32.0,"(b) Q10m change by CORE (v1_2)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i sph2m_corr.gm -o sph10m_corr_v1_2-p4-p3.eps'
'!rm sph2m_corr.gm'
*====================================================
