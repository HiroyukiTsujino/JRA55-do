...
'd f.3*3.654e5'
*
label(34,15.2,"(a) Evaporation",30,0,0.13)
*label(28,3.95,"Precip (blue)  Evap (red)",30,0,0.12)
*label(-5,14,"[Sv]",4,90,0.12)
label(-6,14.0,"10^9 [kg/sec]",4,90,0.12)
...
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 9 13.7 JRA55-raw'
'set string 1 c 3'
*
'set line 2 1 10'
...
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 9 13.5 JRA55-do'
'set string 1 c 3'
*
'set line 3 1 10'
...
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 9 13.3 CORE'
'set string 1 c 3'
*
*----------------------------------------------------------
*
...
label(34,14.0,"(b) Precipitation",30,0,0.13)
*label(-5,0,"[Sv]",4,90,0.12)
label(-6,12.85,"10^9 [kg/sec]",4,90,0.12)
...
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 9 12.5 GPCP-v2.3'
'set string 1 c 3'
*
'set line 2 1 10'
...
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 9 12.3 JRA55-do'
'set string 1 c 3'
*
'set line 3 1 10'
...
*
*label(28,3.5,"E-P",30,0,0.12)
label(34,2.2,"(c) E - P ",30,0,0.13)
*label(-5,0,"[Sv]",4,90,0.12)
label(-6,1.2,"10^9 [kg/sec]",4,90,0.12)
label(34,0.1,"[Year]",30,0,0.12)
*--------------
* line legend
'set line 2 1 10'
...
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 9 0.45 JRA55-do'
'set string 1 c 3'
*
'set line 3 1 10'
'run drawline_gr2xy.gs 20 0.45 25 0.45'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 26 0.45 CORE'
'set string 1 c 3'
*
*'close 9'
*'close 8'
...
'close 1'
*----------------------------------------------------
'printim figs/waterflux_jra55_v1_3.png white'
*'enable print waterflux.gm'
*'print'
*'disable print'
*'!gxeps -c -i waterflux.gm -o waterflux_jra55_v1_3.eps'
*'!rm -f waterflux.gm'
*====================================================
