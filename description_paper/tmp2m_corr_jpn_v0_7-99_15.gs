...
'd ave(tmp2m,t=1,t=12)'
*
label(140.0,68.0,"T2m offset factor v0.7 (1998-present)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 1.5 1 4'
*
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i tmp2m_corr.gm -o tmp2m_corr_jpn_v0_7-99_15.eps'
'!rm tmp2m_corr.gm'
*====================================================
