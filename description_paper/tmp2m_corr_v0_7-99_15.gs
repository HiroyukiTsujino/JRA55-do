...
'd ave(tmp2m,t=1,t=12)'
*
label(205.0,98.0,"(e) T2m offset factor (1998-present)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 0.5 1 4'
*
'close 1'
*-------------------------------------------------------------
'open tmp2m_ice_corr.1999_2015.ctl'
...
'd ave(tmp2m,t=1,t=12)'
*
label(0.0,40.0,"(f) T2m offset factor over sea ice (1998-present)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i tmp2m_corr.gm -o tmp2m_corr-99_15.eps'
'!rm tmp2m_corr.gm'
*====================================================
