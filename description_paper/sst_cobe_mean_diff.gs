...
'reinit'
*-----------------------------------
'open sst_moncl_cobesst.1981_2010.ctl'
'open sst_moncl_hurrellsst.1981_2010.ctl'
...
'd index.3'
*
 label(205.0,98.0,"COBESST (1981-2010)",30,0,0.15)
*'draw string 8.0 1.25 [cm]'
'run cbarn2.gs 0.85 0 4.25 6.0 0 5'
*
*----------------------------------------------------
'set vpage 0.00 8.50 0.00 11.00'
...
'set ccolor 1'
'set clab off'
'set clevs -1.0 -0.5 0.5 1.0'
'set cthick 1'
'set cstyle 1'
'd ave(t.1-t.2,t=1,t=12)'
 label(205.0,98.0,"COBESST - HurrellSST (1981-2010)",30,0,0.15)
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
*
'set strsiz 0.08'
'draw string 7.5 0.5 [degC]'
'set strsiz 0.1'
'run cbarn2.gs 0.85 0 4.25 0.75 1 10'
'set string 1 l 2'
'set strsiz 0.06'
'query w2xy 40.0 60.0'
lab = "Contour: -1.0, -0.5, 0.5, 1.0 (degC)"
xp = subwrd(result,3)
yp = subwrd(result,6)
'draw string 'xp ' 'yp' 'lab
*'run drawstring.gs 40.0 60.0 '
*'set strsiz 0.06'
*'run drawstring.gs 40.0 50.0 -1.0,-0.5,0.5,1.0(degC)'
*
'close 3'
'close 2'
'close 1'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o sst_cobe_mean_diff.eps'
'!rm -f hflux.gm'
*====================================================
