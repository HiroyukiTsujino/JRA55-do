...
'reinit'
*------------------------------------------------
'open dswrf_zm_core.ctl'
'open swdn_zm_ceres_clim.ctl'
'open swdn_zm_ceres_clim_reduced_seaice.ctl'
*
...
'set cthick 5'
'set cmark 0'
'd ave(f.1,time=jan1984,time=dec2007)'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
'd ave(f.2,time=jan2016,time=dec2016)'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(f.3,time=jan2016,time=dec2016)'
*
label(0,275,"(a) Downward shortwave radiation",30,0,0.12)
...
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 255.0 CERES'
'set string 1 c 3'
*
'set line 2 1 5'
'run drawline.gs -80.0 245.0 -65.0 245.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 245.0 CERES-adjusted'
'set string 1 c 3'
*
'set line 3 1 5'
'run drawline.gs -80.0 235.0 -65.0 235.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 235.0 CORE'
'set string 1 c 3'
*
'close 3'
'close 2'
...
'set cthick 5'
'set cmark 0'
'd ave(f.2,time=jan2016,time=dec2016)/ave(f.1,time=jan2016,time=dec2016)'
label(0,1.028,"(b) Fraction of adjusted CERES swdn to original",50,0,0.12)
*
'close 2'
'close 1'
*-----------------------------------
...
'print'
'disable print'
'!gxeps -c -i dswrf.gm -o dswrf_zm_comp_ceres.eps'
'!rm -f dswrf.gm'
*====================================================
