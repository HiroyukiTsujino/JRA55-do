...
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.053 00.0 JRA55-do-v1.2'
'set string 1 c 3'
*
'set line 2 1 5'
'run drawline.gs 0.03 -10.0 0.05 -10.0'
...
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.053 -10.0 JRA55-do-v1.3'
'set string 1 c 3'
...
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.053 -20.0 v1.3-v1.2'
'set string 1 c 3'
*
*
*'close 3'
...
'print'
'disable print'
'!gxeps -c -i tau_comp.gm -o tauy_comp_pac_atl_scow_v1_3_prod4.eps'
'!\rm tau_comp.gm'
*====================================================
