...
'reinit'
*------------------------------------------------
'open tmp2m_ocn_corr.1973_1996.ctl'
*
...
'd ave(tmp2m,t=1,t=12)'
*
label(205.0,98.0,"(c) T2m offset factor (1973-1997)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 0.5 1 4'
*
'close 1'
*-------------------------------------------------------------
'open tmp2m_ice_corr.1973_1996.ctl'
...
'd ave(tmp2m,t=1,t=12)'
*
label(0.0,40.0,"(d) T2m offset factor over sea ice (1973-1997)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i tmp2m_corr.gm -o tmp2m_corr-73_96.eps'
'!rm tmp2m_corr.gm'
*====================================================
