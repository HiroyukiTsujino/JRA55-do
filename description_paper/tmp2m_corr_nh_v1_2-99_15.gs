...
'open tmp2m_ocn_corr.1999_2015.ctl'
*
...
'set grads off'
'd ave(tmp2m.1-tmp2m.2,t=1,t=12)'
*
'set gxout contour'
'set ccolor 1'
'set clab off'
...
'd ave(tmp2m.1-tmp2m.2,t=1,t=12)'
*
label(260.0,80.0,"T2m offset factor difference v1.2 - v1.1 (1998-present)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i tmp2m_corr.gm -o tmp2m_corr_nh_v1_2-99_15.eps'
'!rm tmp2m_corr.gm'
*====================================================
