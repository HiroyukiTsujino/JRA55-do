...
'reinit'
*------------------------------------------------
'open mwtrans-corely2009.ctl'
'open mwtrans-v1_1.ctl'
*
...
'set ylint 0.25'
*
'define glbadj=ave(-glb.3,time=jan1984,time=jan2006)*1e-9'
*
'set ccolor 3'
'set cthick 5'
'set cmark 0'
*'d ave(glb.1,time=jan1984,time=jan2006)*1e-9 + glbadj'
'd ave(glb.1,time=jan1984,time=jan2006)*1e-9'
*'set ccolor 2'
*'set cthick 5'
*'set cmark 0'
*'d ave(glb.2,time=jan1984,time=jan2006)*1e-9 + glbadj'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
'd ave(glb.2,time=jan1984,time=jan2006)*1e-9 + glbadj'
*
label(0.0,1.3,"GLOBAL FWT (1984-2006)",30,0,0.12)
label(-110,0.0,"[Sv]",4,90,0.10)
label(0.0,-1.35,"latitude",30,0,0.12)
*
splt(0.0,0,180)
obswitherr( 45.0,-0.52, 0.25, 4, 0.08)
obswitherr( 35.0,-0.93, 0.25, 4, 0.08)
obswitherr( 24.0,-0.23, 0.25, 4, 0.08)
obswitherr( 10.0, 0.15, 0.25, 4, 0.08)
obswitherr(-19.5,-0.43, 0.61, 4, 0.08)
obswitherr(-32.0, 0.61, 0.25, 4, 0.08)
*---------------------------------------------------------------
'set vpage 0.0 11.0 0.0 8.5'
...
'set ylint 0.25'
*
'define	inpadj=ave(inp.3,time=jan1984,time=jan2006)*1e-9'
*
'set ccolor 3'
'set cthick 5'
'set cmark 0'
*'d ave(inp.1,time=jan1984,time=jan2006)*1e-9 + inpadj'
'd ave(inp.1,time=jan1984,time=jan2006)*1e-9'
*'set ccolor 2'
*'set cthick 5'
*'set cmark 0'
*'d ave(inp.2,time=jan1984,time=jan2006)*1e-9 + inpadj'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
'd ave(inp.2,time=jan1984,time=jan2006)*1e-9 + inpadj'
*
label(0.0,1.3,"Indo-Pacific FWT (1984-2006)",30,0,0.12)
label(-110,0.0,"[Sv]",4,90,0.10)
label(0.0,-1.35,"latitude",30,0,0.12)
*
splt(0.0,0,180)
*
obswitherr( 47.0,-0.27, 0.00, 4, 0.08)
obswitherr( 35.0,-0.56, 0.00, 4, 0.08)
obswitherr( 24.0,-0.21, 0.00, 4, 0.08)
obswitherr( 10.0, 0.03, 0.00, 4, 0.08)
obswitherr(-18.0,-0.33, 0.00, 4, 0.08)
obswitherr(-32.0, 0.37, 0.00, 4, 0.08)
*---------------------------------------------------------------
'set vpage 0.0 11.0 0.0 8.5'
...
'set ylint 0.25'
*
'define	atladj=ave(atl.3,time=jan1984,time=jan2006)*1e-9'
*
'set ccolor 3'
'set cthick 5'
'set cmark 0'
*'d ave(atl.1,time=jan1984,time=jan2006)*1e-9 + atladj'
'd ave(atl.1,time=jan1984,time=jan2006)*1e-9'
*'set ccolor 2'
*'set cthick 5'
*'set cmark 0'
*'d ave(atl.2,time=jan1984,time=jan2006)*1e-9 + atladj'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
'd ave(atl.2,time=jan1984,time=jan2006)*1e-9 + atladj'
*
label(0.0,1.3,"Arctic-Atlantic FWT (1984-2006)",30,0,0.12)
label(-110,0.0,"[Sv]",4,90,0.10)
label(0.0,-1.35,"latitude",30,0,0.12)
*
splt(0.0,0,180)
*
obswitherr( 45.0,-0.25, 0.00, 4, 0.08)
obswitherr( 35.0,-0.37, 0.00, 4, 0.08)
obswitherr( 24.0,-0.03, 0.00, 4, 0.08)
obswitherr( 11.0, 0.12, 0.00, 4, 0.08)
obswitherr(-19.0,-0.10, 0.00, 4, 0.08)
obswitherr(-30.0, 0.24, 0.00, 4, 0.08)
*---------------------------------------------------------------
'close 3'
'close 2'
'close 1'
...
'print'
'disable print'
'!gxeps -c -i water.gm -o mwt_comp_core_ly2009.eps'
'!rm -f water.gm'
*==============================================================
