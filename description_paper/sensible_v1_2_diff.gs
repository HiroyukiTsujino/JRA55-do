...
'set grads off'
'd ave(sensible.1,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
*
'd ave(sensible.1,time=jan1988,time=jan2007)'
 label(205.0,98.0,"Sensible heat flux JRA55-do (1988-2007)",30,0,0.15)
...
'set grads off'
'd ave(sensible.1-sensible.2,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o sensible_diff.eps'
'!rm -f hflux.gm'
*====================================================
