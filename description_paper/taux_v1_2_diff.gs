...
'reinit'
*-----------------------------------
'open jra55_v1_2_taux.ctl'
'open core_aug2017_taux.ctl'
...
'set grads off'
'd ave(taux.1,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'set cthick 2'
'd ave(taux.1,time=jan1988,time=jan2007)'
 label(205.0,98.0,"Zonal wind stress JRA55-do (1988-2007) CI=0.05",30,0,0.15)
...
'set grads off'
'd ave(taux.1-taux.2,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o taux_diff.eps'
'!rm -f hflux.gm'
*====================================================
