...
*------------------------------------------------
*
'open jra55_v0_1_taux_pac_zm.ctl'
'open jra55_v1_1_taux_pac_zm.ctl'
'open core_taux_pac_zm.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.25 3.75 7.0 10.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'set cthick 3'
'set cmark 0'
'd ave(f.1,time=jan1988,time=jan2007)'
*
'set ccolor 4'
'set cthick 3'
'set cmark 0'
'd ave(f.2,time=jan1988,time=jan2007)'
*
'set ccolor 3'
'set cthick 3'
'set cmark 0'
'd ave(f.3,time=jan1988,time=jan2007)'
*
splt2(0.0,-40,75)
label(0.0,80.0,"Zonal wind stress (Pacific)",25,0,0.12)
...
*------------------------------------------------
*
'open jra55_v0_1_taux_atl_zm.ctl'
'open jra55_v1_1_taux_atl_zm.ctl'
'open core_taux_atl_zm.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 4.5 7.0 7.0 10.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
*
splt2(0.0,-40,75)
label(0.0,80.0,"Zonal wind stress (Atlantic)",25,0,0.12)
*label(-7,7.35,"[m/s]",4,90,0.11)
*label(34,6.95,"[Year]",30,0,0.12)
*
*
...
*----------------------------------------------------
*
'open jra55_v0_1_tauy_pac_zm.ctl'
'open jra55_v1_1_tauy_pac_zm.ctl'
'open core_tauy_pac_zm.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.25 3.75 3.0 6.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
*
splt2(0.0,-40,75)
label(0.0,80.0,"Meridional wind stress (Pacific)",25,0,0.12)
*label(-7,7.35,"[m/s]",4,90,0.11)
*label(34,6.95,"[Year]",30,0,0.12)
*
*
...
*------------------------------------------------
*
'open jra55_v0_1_tauy_atl_zm.ctl'
'open jra55_v1_1_tauy_atl_zm.ctl'
'open core_tauy_atl_zm.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 4.5 7.0 3.0 6.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
*
splt2(0.0,-40,75)
label(0.0,80.0,"Meridional wind stress (Atlantic)",25,0,0.12)
*label(-7,7.35,"[m/s]",4,90,0.11)
*label(34,6.95,"[Year]",30,0,0.12)
*
*
...
*----------------------------------------------------
*
'open jra55_v0_1_taux_so_zm.ctl'
'open jra55_v1_1_taux_so_zm.ctl'
'open core_taux_so_zm.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.25 3.75 0.5 2.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
*
splt2(0.0,-80,-28)
label(0.075,-24.0,"Zonal wind stress (SO)",25,0,0.12)
*label(-7,7.35,"[m/s]",4,90,0.11)
*label(34,6.95,"[Year]",30,0,0.12)
*
*
...
*------------------------------------------------
*
'open jra55_v0_1_tauy_so_zm.ctl'
'open jra55_v1_1_tauy_so_zm.ctl'
'open core_tauy_so_zm.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 4.5 7.0 0.5 2.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
*
splt2(0.0,-80,-28)
label(0.0,-24.0,"Meridional wind stress (SO)",25,0,0.12)
*label(-7,7.35,"[m/s]",4,90,0.11)
*label(34,6.95,"[Year]",30,0,0.12)
*
*
...
'print'
'disable print'
'!gxeps -c -i tau_comp.gm -o tau_comp_pac_atl.eps'
'!\rm tau_comp.gm'
*====================================================
