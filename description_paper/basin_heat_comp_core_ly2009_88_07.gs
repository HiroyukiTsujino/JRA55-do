...
'reinit'
*------------------------------------------------
'open basinheat-core_aug2017_ly2009.ctl'
'open basinheat-v0_1noadj.ctl'
'open basinheat-v1_3noadj.ctl'
*-----------------------------------------------
...
'set cthick 5'
'set cmark 0'
'd ave(glb.2,time=jan1988,time=jan2007)*1e-15'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(glb.3,time=jan1988,time=jan2007)*1e-15'
label(0.0,0.26,"GLOBAL Qtotal (1988-2007)",30,0,0.12)
label(-110,0.0,"[PW]",4,90,0.10)
label(0.0,-0.12,"latitude",30,0,0.12)
*
splt(0.0,0,180)
*---------------------------------------------------------------
*
*'set line 3 1 5'
*'run drawline.gs -80.0 0.235 -55.0 0.235'
*'set line 1 1 1'
*'set string 1 l 3'
*'set strsiz 0.10'
*'run drawstring.gs -50.0 0.235 CORE'
*'set string 1 c 3'
*
*'set line 4 1 5'
*'run drawline.gs -80.0 0.22 -55.0 0.22'
*'set line 1 1 1'
*'set string 1 l 3'
*'set strsiz 0.10'
*'run drawstring.gs -50.0 0.22 JRA55-raw'
*'set string 1 c 3'
*
*'set line 2 1 5'
*'run drawline.gs -80.0 0.205 -55.0 0.205'
*'set line 1 1 1'
*'set string 1 l 3'
*'set strsiz 0.10'
*'run drawstring.gs -50.0 0.205 JRA55-do'
*'set string 1 c 3'
*
*---------------------------------------------------------------
'set vpage 0.0 11.0 0.0 8.5'
...
'set cthick 5'
'set cmark 0'
'd ave(inp.2,time=jan1988,time=jan2007)*1e-15'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(inp.3,time=jan1988,time=jan2007)*1e-15'
label(0.0,0.26,"Indo-Pacific Qtotal (1988-2007)",30,0,0.12)
label(-110,0.0,"[PW]",4,90,0.10)
label(0.0,-0.12,"latitude",30,0,0.12)
*
splt(0.0,0,180)
...
'set cthick 5'
'set cmark 0'
'd ave(atl.2,time=jan1988,time=jan2007)*1e-15'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
'd ave(atl.3,time=jan1988,time=jan2007)*1e-15'
label(0.0,0.26,"Arctic-Atlantic Qtotal (1988-2007)",30,0,0.12)
label(-110,0.0,"[PW]",4,90,0.10)
label(0.0,-0.12,"latitude",30,0,0.12)
*
splt(0.0,0,180)
...
'print'
'disable print'
'!gxeps -c -i dswrf.gm -o basin_heat_comp_core_ly2009_88_07.eps'
'!rm -f dswrf.gm'
*==============================================================
