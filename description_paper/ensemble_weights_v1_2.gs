...
'd index*index.2'
*
label(205.0,98.0,"Additional weighting factor for low-res reanalysis",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i sph2m_corr.gm -o ensemble_weights_v1_2.eps'
'!rm sph2m_corr.gm'
*====================================================
