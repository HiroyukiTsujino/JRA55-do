...
*
'open nswrf_glb_v1_2pre.ctl'
'open nlwrf_glb_v1_2pre.ctl'
'open latent_glb_v1_2pre.ctl'
'open sensible_glb_v1_2pre.ctl'
*
'open nswrf_glb_core_jan2017.ctl'
'open nlwrf_glb_core_jan2017.ctl'
'open latent_glb_core_jan2017.ctl'
'open sensible_glb_core_jan2017.ctl'
*
'open dswrf_glb_v1_2pre.ctl'
'open dlwrf_glb_v1_2pre.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.0 8.0 9.0 10.3'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.9'
*
label(32,177,"(a) Net short wave",30,0,0.12)
label(-5,167.5,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.0 8.0 7.2 8.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.10'
*
label(32,-43.0,"(b) Net long wave",30,0,0.12)
label(-5,-52.5,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.0 8.0 5.4 6.7'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.11'
*
label(32,-83,"(c) Latent heat flux",30,0,0.12)
label(-5,-92.5,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.0 8.0 3.6 4.9'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.12'
*
label(32,-11.3,"(d) Sensible heat flux",30,0,0.12)
label(-5,-15,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.0 8.0 1.8 3.1'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
*'set cmark 4'
'set cmark 0'
'd (f.5*0.9880615 + f.14*0.9880615 + (f.6-f.14)+f.7+f.8)'
*
'set ccolor 3'
'set cthick 5'
*'set cmark 9'
...
splt(0.0,1,69)
*
label(32,17.5,"(e) TOTAL surface heat flux",30,0,0.12)
label(-5,5.0,"[W/m2]",4,90,0.11)
label(32,-10,"[Year]",30,0,0.11)
*
'close 14'
'close 13'
*
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o heatflux_jra55_v1_1_v1_2.eps'
'!rm -f heatflux.gm'
*====================================================
