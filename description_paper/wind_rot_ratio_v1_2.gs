...
'reinit'
*------------------------------------------------
'open wind_rot_ceof_annual_v1_2.1999_2015.ctl'
...
label(205.0,98.0,"(a) Counter-clockwise rotation factor (whole period)",30,0,0.15)
*
'set string 1 c 3'
'run drawstring.gs 70.0 50.0 CI=4`3.`0'
*
'run cbarn2.gs 0.8 0 4.25 6.0 3 4'
*
'close 3'
'close 2'
'close 1'
...
'd index.3'
*
label(205.0,98.0,"(b) Ratio explained by the 1st mode",30,0,0.15)
*
*'set string 1 c 3'
*'run drawstring.gs 70.0 50.0 CI=4`3.`0'
*
'run cbarn2.gs 0.8 0 4.25 1.0 0 1'
*
'close 3'
'close 2'
'close 1'
*----------------------------------------------------
'enable print wind_rot.gm'
'print'
'disable print'
'!gxeps -c -i wind_rot.gm -o wind_rot_ratio_v1_2.eps'
'!rm wind_rot.gm'
*====================================================
