...
*
'set line 3 1 5'
'run drawline.gs -80.0 10.0 -65.0 10.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 10.0 CORE'
'set string 1 c 3'
*
'set line 4 1 5'
'run drawline.gs -80.0 9.5 -65.0 9.5'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 9.5 JRA55-raw'
'set string 1 c 3'
*
'set line 2 1 5'
'run drawline.gs -80.0 9.0 -65.0 9.0'
'set line 1 1 1'
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs -60.0 9.0 JRA55-do'
'set string 1 c 3'
*
*----------------------------------------------------
*
