...
'reinit'
*-----------------------------------
'open jra55_v1_2_precip.ctl'
'open jra55_v1_2_evapor.ctl'
'open core_aug2017_precip.ctl'
'open core_aug2017_evapor.ctl'
...
'set gxout shaded'
'run colmap.gs rbb64'
'run clevsreg.gs -62 62 2'
'set grads off'
'd smth9(ave(precip.1-evapor.2,time=jan1988,time=jan2007))*1e6'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.5'
...
'set cthick 2'
'd smth9(ave(precip.1-evapor.2,time=jan1988,time=jan2007))*1e6'
 label(205.0,98.0,"P - E JRA55-do (1988-2007)",30,0,0.15)
'set strsiz 0.08'
'draw string 8.0 0.5 [mg/m2/sec]'
'set strsiz 0.1'
'run cbarn2.gs 0.85 0 4.25 6.0 1 10'
*'run cbarn2.gs 0.85 0 4.25 0.5 0 10'
*----------------------------------------------------
'set vpage 0.00 8.50 0.00 11.00'
...
'set gxout shaded'
'run colmap.gs rb26'
'run clevsreg.gs -12 12 1'
'set grads off'
'd smth9(ave(precip.1-evapor.2-precip.3+evapor.4,time=jan1988,time=jan2007))*1e6'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.5'
...
'run cbarn2.gs 0.85 0 4.25 0.8 2 5'
*----------------------------------------------------
*
'close 5'
'close 4'
...
'close 1'
*
'enable print wflux.gm'
'print'
'disable print'
'!gxeps -c -i wflux.gm -o wflux_total_diff.eps'
'!rm -f wflux.gm'
*====================================================
