...
'set gxout shaded'
'run colmap.gs rbb64'
'run clevsreg.gs -248 248 8'
'set grads off'
'd ave(latent.1,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'set cthick 2'
'd ave(latent.1,time=jan1988,time=jan2007)'
 label(205.0,98.0,"Latent heat flux JRA55-do (1988-2007)",30,0,0.15)
...
'set gxout shaded'
'run colmap.gs rb26'
'run clevsreg.gs -30.0 30.0 2.5'
'set grads off'
'd ave(latent.1-latent.2,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'set strsiz 0.1'
'run cbarn2.gs 0.85 0 4.25 0.75 0 4'
*
*----------------------------------------------------
'close 3'
'close 2'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o latent_diff.eps'
'!rm -f hflux.gm'
*====================================================
