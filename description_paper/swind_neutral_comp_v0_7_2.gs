...
'close 1'
*
'open wvn10m_zm_v0_7_2-TL319.ctl'
'set lat -90 90'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
...
'close 1'
*
label(0,11.8,"Zonal mean neutral wind at 10 m (nov1999-oct2009)",30,0,0.12)
...
'print'
'disable print'
'!gxeps -c -i wind10m_comp.gm -o wind10m_neutral_comp_v0_7_2.eps'
