...
'set grads off'
'd (ave(corr_sph.1,t=1,t=12)/ave(corr_sph.2,t=1,t=12) - 1.0)*100'
*
'set gxout contour'
'set ccolor 1'
'set clab off'
...
'd (ave(corr_sph.1,t=1,t=12)/ave(corr_sph.2,t=1,t=12) - 1.0)*100'
*
label(260.0,80.0,"Q2m multiplicative factor change (%) v1.2 - v1.1 (1998-present)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i sph2m_corr.gm -o sph2m_corr_nh_v1_2-99_15.eps'
'!rm sph2m_corr.gm'
*====================================================
