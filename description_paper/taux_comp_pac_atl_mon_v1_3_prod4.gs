...
'open jra55_v1_2_taux_pac_zm_mon_TL319.ctl'
...
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.058 0.0 JRA55-do-v1.2'
'set string 1 c 3'
*
'set line 2 1 5'
'run drawline.gs 0.04 -10.0 0.055 -10.0'
...
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.058 -10.0 JRA55-do-v1.3'
'set string 1 c 3'
*
'set line 14 1 5'
...
'set string 1 l 3'
'set strsiz 0.10'
'run drawstring.gs 0.058 -20.0 v1.3-v1.2'
'set string 1 c 3'
*
*
*'close 3'
...
'open jra55_v1_2_taux_atl_zm_mon_TL319.ctl'
...
'open jra55_v1_2_taux_so_zm_mon_TL319.ctl'
...
'print'
'disable print'
'!gxeps -c -i tau_comp.gm -o taux_comp_pac_atl_scow_v1_3_prod4.eps'
'!\rm tau_comp.gm'
*====================================================
