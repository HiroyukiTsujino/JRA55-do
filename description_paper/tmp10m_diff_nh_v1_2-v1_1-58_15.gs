...
'set lon 80 440'
'set lat 5  75'
'define tmpdiff=ave(tmp10m.1-tmp10m.2,time=jan1958,time=dec2016)'
'set xlint 20'
'set ylint 5'
'set grid on'
'set mproj scaled'
...
'd tmpdiff'
*
label(260.0,80.0,"T10m difference v1.2 - v1.1 (1958-2016)",30,0,0.15)
'run cbarn2.gs 0.8 0 5.25 4.0 0 2'
*
'close 2'
'close 1'
*----------------------------------------------------
'enable print tmp10m_diff.gm'
'print'
'disable print'
'!gxeps -c -i tmp10m_diff.gm -o tmp10m_diff_nh_v1_2-58_16.eps'
'!rm tmp10m_diff.gm'
*====================================================
