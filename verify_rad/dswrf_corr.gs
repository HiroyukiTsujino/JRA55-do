...
*'draw string 8.0 1.25 [cm]'
 label(240.0,98.0,"(a) SW multiplicative factor (annual mean)",30,0,0.15)
...
'd ave(dswrfcorr,t=1,t=12)'
*'draw string 8.0 1.25 [cm]'
 label(240.0,98.0,"(b) smoothed SW multiplicative factor (annual mean)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
'close 1'
*----------------------------------------------------
