...
*'draw string 8.0 1.25 [cm]'
 label(205.0,98.0,"(a) SW multiplicative factor (v0_2)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
'close 1'
*----------------------------------------------------
'open dswrf_corr_latlon.mar2000_feb2015.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
*'d ave(dswrfcorr,t=1,t=12)'
*'draw string 8.0 1.25 [cm]'
 label(205.0,98.0,"(b) SW multiplicative factor (v0_3)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i dswrf.gm -o dswrf_corr_v0_3.eps'
'!rm dswrf.gm'
*====================================================
