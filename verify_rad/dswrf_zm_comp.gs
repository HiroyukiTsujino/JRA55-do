...
*'set cthick 5'
*'set cmark 0'
*'d ave(f.4,time=jan1984,time=dec2007)'
'set ccolor 3'
'set cthick 5'
'set cmark 0'
...
label(0,270,"Downward short wave radiation",30,0,0.12)
...
label(0,1.028,"fraction of adjusted CERES swdn to original",30,0,0.12)
*label(-105,167.5,"[W/m2]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*
'close 2'
