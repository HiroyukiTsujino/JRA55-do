...
*'d ave(dlwrfcorr,t=1,t=12)'
*---
 label(205.0,98.0,"(c) LW multiplicative factor (v0_2)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
'close 1'
*----------------------------------------------------
'open dlwrf_corr_latlon.mar2000_feb2015.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
*'d ave(dlwrfcorr,t=1,t=12)'
*---
 label(205.0,98.0,"(d) LW multiplicative factor (v0_3)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i dlwrf.gm -o dlwrf_corr_v0_3.eps'
'!rm dlwrf.gm'
*====================================================
