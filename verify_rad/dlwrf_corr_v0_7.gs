...
*'d ave(dlwrfcorr,t=1,t=12)'
*---
 label(205.0,98.0,"(c) LW multiplicative factor (v0.8 1958-1972)",30,0,0.15)
...
*'d ave(dlwrfcorr,t=1,t=12)'
*---
 label(205.0,98.0,"(d) LW multiplicative factor (v0.8 1973-2015)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
'close 1'
*----------------------------------------------------
'enable print dlwrf.gm'
'print'
'disable print'
'!gxeps -c -i dlwrf.gm -o dlwrf_corr_v0_7.eps'
'!rm dlwrf.gm'
*====================================================
