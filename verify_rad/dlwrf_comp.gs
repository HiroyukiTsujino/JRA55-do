...
'reinit'
*------------------------------------------------
'open dlwrf_zm_jra55c0.ctl'
'open dlwrf_zm_core.ctl'
'open srb_lwdn_zm.ctl'
'open dlwrf_zm_jra55c2.ctl'
*
...
'set cthick 5'
'set cmark 0'
'd ave(f.2,time=jan1984,time=dec2007)/1000'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
'd ave(f.3,time=jan1984,time=dec2007)'
'set ccolor 14'
'set cthick 5'
'set cmark 0'
'd ave(f.4,time=jan1984,time=dec2007)'
label(0,465,"Downward long wave radiation (1984-2007)",30,0,0.12)
...
'print'
'disable print'
'!gxeps -c -i dlwrf.gm -o dlwrf_comp.eps'
'!rm dlwrf.gm'
*====================================================
