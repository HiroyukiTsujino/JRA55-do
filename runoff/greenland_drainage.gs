...
'set t 1 12'
'define aoclim=ave(ao,t+157,t=516,12)'
'modify aoclim seasonal'
'define bbclim=ave(bb,t+157,t=516,12)'
'modify bbclim seasonal'
'define lsclim=ave(ls,t+157,t=516,12)'
'modify lsclim seasonal'
'define isclim=ave(is,t+157,t=516,12)'
'modify isclim seasonal'
'define nsclim=ave(ns,t+157,t=516,12)'
'modify nsclim seasonal'
*
'set vpage 0.00 8.50 0.00 11.00'
'set parea 1.0 8.0 6.5 10.5'
*
'set xlint 1'
'set ylint 0.001'
'set grid on'
...
'd nsclim*1e-9'
*
label(6.0,0.0053,"run-off (monthly climatology, 1961-1990)",30,0,0.15)
label(0.0,0.0025,"[Sv]",6,90,0.13)
*
*----------------------------------------------------
'enable print green_clim.gm'
'print'
'disable print'
'!gxeps -c -i green_clim.gm -o green_clim.eps'
'!rm green_clim.gm'
*====================================================
