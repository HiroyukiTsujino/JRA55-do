...
'd runoff.2*1e-6'
* 
'define green=ave(ao+bb+ls+is+ns,time=jan1961,time=jan1990)*1e-9'

'set ccolor 3'
'set cthick 5'
'set cmark 3'
'd all.1*1e-9 - 0.073 - green'
*
label(34.5, 1.37, "Globally integrated run-off except for Greenland and Antarctica", 50, 0, 0.12)
label(-5, 1.15, "[Sv]",    4, 90, 0.12)
label(34.5, 0.90, "[Year]", 30,  0, 0.12)
*
*--------------
* line legend
*
'set strsiz 0.10'
'set line 3 1 10'
'run drawline_gr2xy.gs 28 1.32 33 1.32'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 35 1.32 CORE'
'set string 1 c 3'
*
'set line 2 1 10'
'run drawline_gr2xy.gs 44 1.32 49 1.32'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 51 1.32 JRA55-do'
'set string 1 c 3'
'set strsiz 0.12'
*
'close 2'
...
'print'
'disable print'
'!gxeps -c -i runoff.gm -o runoff_comp_core_jra55do.eps'
*====================================================
