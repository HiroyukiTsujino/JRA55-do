...
'reinit'
*------------------------------------------------
'open runoff_annual.ctl'
'open runoff_annual_m1.ctl'
*'open jra55_prcp_integ.ctl'
'open runoff_annual_core.ctl'
*
...
*'set cthick 5'
*'set cmark 4'
*'d prcp_land.2*1e-6 * 0.316456 * 1.036 + 0.073'
*
'set ccolor 4'
'set cthick 5'
'set cmark 4'
'd runoff*1e-6 + 0.073'
*
*label(29,1.53,"Precip on land * 0.316456 Sv (red) Runoff Sv (blue)",50,0,0.12)
label(-5, 1.15, "[Sv]",    4, 90, 0.12)
label(32, 0.90, "[Year]", 30,  0, 0.12)
*
'set ccolor 3'
'set cthick 5'
'set cmark 1'
...
'print'
'disable print'
'!gxeps -c -i runoff.gm -o runoff.eps'
*====================================================
