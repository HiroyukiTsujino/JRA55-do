...
program main
  ...
  namelist /nml_total_runoff_monclim/ file_river_in, dir_out

  !--------------------------------------------------------------------
 
  open(10, file='namelist.total_runoff_monclim')
  read(10, nml=nml_total_runoff_monclim)
  close(10)
  ...
  do nm = 1, 12
    ...
    write(file_riv_tmp,'(1a,1a,i2.2)') trim(file_river_in),'.',nm
