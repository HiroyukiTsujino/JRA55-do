...
*
'open antarc_runoff_cf.ctl'
'open antarc_runoff_bmf.ctl'
*
'set lon 90 450'
'set xlint 30'
'set ylint 1'
...
'd (all.1)*1e-3'
*
label(270.0, 13.3,"Runoff from Antarctica",30,0,0.14)
label( 62.0,  6.0,"[mSv]",6,90,0.12)
label(270.0, -1.1,"[longitude]",6,0,0.12)
*
*--------------
* line legend
*
'set strsiz 0.12'
'set line 3 1 10'
'run drawline.gs 360.0 11.5 390.0 11.5'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring.gs 395.0 11.5 CORE'
'set string 1 c 3'
*
'set line 2 1 10'
'run drawline.gs 360.0 10.5 390.0 10.5'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring.gs 395.0 10.5 JRA55-do'
'set string 1 c 3'
'set strsiz 0.12'
*
*----------------------------------------------------
'enable print antarc_bin.gm'
'print'
'disable print'
'!gxeps -c -i antarc_bin.gm -o antarc_bin.eps'
'!rm antarc_bin.gm'
*====================================================
