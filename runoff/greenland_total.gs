...
'reinit'
*------------------------------------------------
'open runoff_monthly_tsv06_greenland.ctl'
'set t 1 12'
'define greenclim=ave(runoff,t+36,t=396,12)'
...
'd greenclim*1e-6'
*
label(6.0,0.053,"run-off (monthly climatology (T.Suzuki) 1961-1990)",30,0,0.15)
label(0.0,0.025,"[Sv]",6,90,0.13)
*
*----------------------------------------------------
'enable print green_clim.gm'
'print'
'disable print'
'!gxeps -c -i green_clim.gm -o green_clim_ts06.eps'
'!rm green_clim.gm'
*====================================================
