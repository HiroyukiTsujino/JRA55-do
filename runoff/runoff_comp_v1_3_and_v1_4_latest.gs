...
'reinit'
*------------------------------------------------
'open runoff_all_annual_v1_3-sep.ctl'
'open runoff_all_annual_v1_4-sep.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 7.0 10.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'set ylab on'
'set ylab %.1f'
'set vrange 1.04 1.44'
'set ylint 0.1'
'set time jan1958 jan2020'
*
'set ccolor 2'
'set cthick 5'
'set cmark 4'
'd (liquid.2+solid.2)*1e-9'
* 
'set ccolor 4'
'set cthick 5'
'set cmark 4'
'd (liquid.1+solid.1)*1e-9'
* 
label(30.5, 1.47, "(a) Globally integrated run-off", 50, 0, 0.12)
label(-5, 1.22, "[Sv]",    4, 90, 0.12)
label(30.5, 1.00, "[Year]", 30,  0, 0.12)
*
*--------------
* line legend
*
'set strsiz 0.10'
'set line 4 1 10'
'run drawline_gr2xy.gs 28 1.39 33 1.39'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 35 1.39 v1_3'
'set string 1 c 3'
*
'set line 2 1 10'
'run drawline_gr2xy.gs 44 1.39 49 1.39'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 51 1.39 v1_4'
'set string 1 c 3'
'set strsiz 0.12'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 3.0 6.0'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'set cthick 5'
'set cmark 4'
'd (liquid.2+solid.2-liquid.1-solid.1)*1e-6'
*
'set line 1 1 5'
'run drawline_gr2xy.gs 0 0.0 63 0.0'
* 
label(30.5, 23., "(b) v1_4 - v1_3", 10, 0, 0.12)
label(-5, 3.0, "[mSv]",    4, 90, 0.12)
label(30.5, -15., "[Year]", 30,  0, 0.12)
*
*--------------
'close 2'
'close 1'
*----------------------------------------------------
'printim figs/runoff_comp_jra55do_v1_3-v1_4.png white'
*'enable print runoff.gm'
*'print'
*'disable print'
*'!gxeps -c -i runoff.gm -o runoff_comp_jra55do_v1_3-v1_4.eps'
*====================================================
