...
*------------------------------------------------
*
'set vpage 0.00 8.50 5.50 11.00'
'set parea 1.00 8.00 0.50  4.50'
*
*------------------------------------------------
'open runoff_monthly_bamber.ctl'
*
'set xlint 1'
'set ylint 0.01'
'set grid on'
...
splt(0.0,1,12)
*
'open core_greenland_monthly.ctl'
'set t 1 12'
'define greenclim=ave(ao+bb+ls+is+ns,t+157,t=516,12)'
'modify greenclim seasonal'
*
'set gxout line'
'set vrange -0.012 0.082'
'set cthick 10'
...
*
*
label(6.5,0.088,"Runoff from Greenland (1961-1990)",30,0,0.15)
label(0.0,0.04,"[Sv]",6,90,0.13)
*
*--------------
* line legend
*
'set strsiz 0.12'
'set line 3 1 10'
'run drawline_gr2xy.gs 2 0.072 3 0.072'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 3.5 0.072 CORE'
'set string 1 c 3'
*
'set line 2 1 10'
'run drawline_gr2xy.gs 2 0.064 3 0.064'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 3.5 0.064 JRA55-do'
'set string 1 c 3'
'set strsiz 0.12'
*
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i green_clim.gm -o green_clim_core.eps'
'!rm green_clim.gm'
*====================================================
