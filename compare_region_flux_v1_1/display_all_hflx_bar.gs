...
rc = writebars(t1, t2, lonbase.i, latbase.i, 0)
*
'close 13'
'close 12'
'close 11'
...
'close 1'
*==============================================================
function writebars  ( argv1, argv2, argv3, argv4, argv5 )
*--------------------------------------------------------------
...
say ' '
say 'Total'
'd ave(f.2+f.5+f.8+f.11,t='t1',t='t2')'
line2=sublin(result,2)
aa=subwrd(line2,4)
say '  JRA55-raw  'aa
'd ave(f.3+f.6+f.9+f.12,t='t1',t='t2')'
line2=sublin(result,2)
aa=subwrd(line2,4)
say '  JRA55-do   'aa
'd ave(f.4+f.7+f.10+f.13,t='t1',t='t2')'
line2=sublin(result,2)
aa=subwrd(line2,4)
say '  CORE       'aa
...
say 'Latent'
target="JRA55-raw"
rc = setAREAnum (t1, t2, 8, 10, target)
rc = drawLineMark( lon1, lat1, _finvdif, 2, opt1, 6, 0.1)
target="JRA55-do"
rc = setAREAnum (t1, t2, 9, 10, target)
rc = drawLineMark( lon1, lat1, _finvdif, 4, opt1, 8, 0.1)
...
say 'Sensible'
target="JRA55-raw"
rc = setAREAnum (t1, t2, 11, 13, target)
rc = drawLineMark( lon1, lat1, _finvdif, 2, opt1, 6, 0.1)
target="JRA55-do"
rc = setAREAnum (t1, t2, 12, 13, target)
rc = drawLineMark( lon1, lat1, _finvdif, 4, opt1, 8, 0.1)
