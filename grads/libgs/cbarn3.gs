...
* 
*	run cbarn3.gs sf vert xmid ymid strt intvl
*
*	sf   - scale the whole bar 1.0 = original 0.5 half the size, etc.
*	vert - 0 FORCES a horizontal bar = 1 a vertical bar
*	xmid - the x position on the virtual page of the center of the bar
*	ymid - the y position on the virtual page of the center of the bar
*	strt - the start number for drawing index
*	intv  - the interval for drawing index
*
