...
if(version="")
 say ' Usage: sverdrup #version'
 exit
endif
*------------------------------------------------
'reinit'
*------------------------------------------------
'open sverdrup_'version'.ctl'
*
'set vpage 0.0 11.0 0.0 8.5'
'set parea 0.5 10.5 4.0 8.0'
*
'set lon 100 380'
'set lat -15 65'
'set xlint 20'
...
*
'set gxout shaded'
'run clevsreg.gs -45 45 5'
'run colmap.gs odcm2'
'set grads off'
'd smth9(ave(sv,time=jan2000,time=dec2009))*1e-12'
'set gxout contour'
'set ccolor 1'
'set clab off'
'set cint 5'
...
*'draw string 8.0 1.25 [cm]'
 label2(230.0,68.0,"Sverdrup Function ["version"] (2000-2009)",20,0,0.15)
'run cbarn2.gs 0.8 0 5.5 3.5 1 2'
*
'close 1'
*----------------------------------------------------
'enable print sverdrup.gm'
'print'
'disable print'
'!gxeps -c -i sverdrup.gm -o sverdrup_'version'.eps'
'!rm -f sverdrup.gm'
*====================================================
