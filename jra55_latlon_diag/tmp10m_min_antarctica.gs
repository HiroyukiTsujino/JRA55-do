...
'set gxout shaded'
'run colmap.gs odcm2'
'run clevsreg -64 10 4'
'set grads off'
'd min(tmp10m_min,time=jan1999,time=dec2009)-273.15'
*
*'set gxout contour'
*'set ccolor 1'
*'set clab off'
...
*'set cthick 2'
*'set grads off'
*'d min(tmp10m_min,time=jan2000,time=dec2000)-273.15'
*
label(240.0,-48.0,"Minimum of 10m air temperature (jan1999 - dec2009)",30,0,0.14)
'run cbarn2.gs 0.8 0 4.25 5.5 0 2'
*
'close 1'
*----------------------------------------------------
'enable print tmp10m_min.gm'
'print'
'disable print'
'!gxeps -c -i tmp10m_min.gm -o tmp10m_min_antarctica.eps'
'!rm tmp10m_min.gm'
*====================================================
