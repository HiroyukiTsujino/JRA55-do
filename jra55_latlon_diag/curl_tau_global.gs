...
*-------------------------------
filem="curl.gm"
fileo="curl_global_"zero month"_"version".eps"
*-------------------------------
'reinit'
'enable print 'filem
*-------------------------------
...
label(180.0,85.0,"Curl tau in "cmon". [x 1e-7 N/m] ("version") [Sep.1999-Oct.2009]",60,0,0.10)
*-------------------------------
...
label(180.0,85.0,"Curl tau in "cmon". [x 1e-7 N/m] (SCOW) [Sep.1999-Oct.2009]",60,0,0.10)
