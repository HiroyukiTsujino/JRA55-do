...
'reinit'
*------------------------------------------------
'open swind_remss_actual_wind_60S60N.ctl'
'open swind_qscat_actual_wind_60S60N.ctl'
'open wind10m_c0_60S60N.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 6.0 10.0'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.3'
*
label(132,8.15,"10 m actual wind speed (60S-60N average)",30,0,0.12)
label(-30,7.5,"[m/s]",4,90,0.11)
label(132,6.80,"[Year]",30,0,0.12)
*
*------------------------------------------------------
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 1.0 5.0'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.3-f.1'
*
label(132,0.19,"10 m actual wind speed difference from REMSS (60S-60N average)",30,0,0.12)
label(-30,-0.1,"[m/s]",4,90,0.11)
label(132,-0.78,"[Year]",30,0,0.12)
*
*
'close 3'
'close 2'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o wind10m_60s60n_comp.eps'
'!\rm heatflux.gm'
*====================================================
