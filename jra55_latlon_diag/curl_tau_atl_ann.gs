...
label(330.0,78.0,"WSC annual mean [x 1e-7 N/m] ("version") [Nov.1999-Oct.2009]",60,0,0.10)
*-------------------------------
'set vpage 0.0 11.0 0.0 8.5'
...
label(330.0,78.0,"WSC annual mean [x 1e-7 N/m] (SCOW) [Sep.1999-Oct.2009]",60,0,0.10)
'run cbarn2.gs 0.8 0 5.25 0.5 0 2'
*-------------------------------
filem="curl.gm"
fileo="curl_atl_ann_"version".eps"
filep="curl_atl_ann_"version".png"
'printim 'filep' white'
'enable print 'filem
'print'
'disable print'
