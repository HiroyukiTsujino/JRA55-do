...
*'open sv_v0_7_2.ctl'
*'open sv_v1_3.ctl'
*'open sv_v1_4pre1.ctl'
'open sv_v1_4.ctl'
*
'set vpage 0.0 11.0 0.0 8.5'
'set parea 0.5 3.5 5.5 8.0'
*
'set lon 122 260'
'set lat 10 50'
'set xlint 20'
...
'set gxout shaded'
'run colmap.gs odcm3'
'run clevsreg.gs -15 45 5'
'set grads off'
'd smth9(ave(sv,time=jan1988,time=dec2007))'
'set gxout contour'
'set ccolor 1'
'set clab on'
'set cint 5'
...
*'draw string 8.0 1.25 [cm]'
 label2(190.0,53.0,"CORE (1988-2007)",20,0,0.15)
'run cbarn2.gs 0.8 0 5.5 5.0 1 2'
*---------------------------------
'set vpage 0.0 11.0 0.0 8.5'
'set parea 4.0 7.0 5.5 8.0'
*
'set lon 122 260'
'set lat 10 50'
'set xlint 20'
...
'run clevsreg.gs -15 45 5'
'set grads off'
'd smth9(ave(sv.2,time=jan1988,time=dec2007))'
'set gxout contour'
'set ccolor 1'
'set clab on'
'set cint 5'
...
'd smth9(ave(sv.2,time=jan1988,time=dec2007))'
*'draw string 8.0 1.25 [cm]'
 label2(190.0,53.0,"JRA55-raw (1988-2007)",20,0,0.15)
'run cbarn2.gs 0.8 0 5.5 5.0 1 2'
*
*---------------------------------
'set vpage 0.0 11.0 0.0 8.5'
'set parea 7.5 10.5 5.5 8.0'
*
'set lon 122 260'
'set lat 10 50'
'set xlint 20'
...
'run clevsreg.gs -15 45 5'
'set grads off'
'd smth9(ave(sv.3,time=jan1988,time=dec2007))'
'set gxout contour'
'set ccolor 1'
'set clab on'
'set cint 5'
...
'd smth9(ave(sv.3,time=jan1988,time=dec2007))'
*'draw string 8.0 1.25 [cm]'
 label2(190.0,53.0,"JRA55-do (1988-2007)",20,0,0.15)
'run cbarn2.gs 0.8 0 5.5 5.0 1 2'
*
*---------------------------------------------------
* time series
...
'set ylint 5'
'set lon 140'
'set time jan1948 dec2017'
*
'set ccolor 3'
'set cthick 2'
'set cmark 0'
'd ave(sv.1,lat=26,lat=32)'
*
'set ccolor 2'
'set cthick 2'
'set cmark 0'
'd ave(sv.2,lat=26,lat=32)'
*
'set ccolor 4'
'set cthick 2'
'set cmark 0'
'd ave(sv.3,lat=26,lat=32)'
*
label(300,51.5,"Kuroshio transport (140E, 26-32N average)",30,0,0.12)
...
*
'set line 2 1 10'
'run drawline_gr2xy.gs 3 48 63 48'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 68 48 JRA55-raw'
'set string 1 c 3'
*
'set line 4 1 10'
'run drawline_gr2xy.gs 203 48 263 48'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 268 48 JRA55-do'
'set string 1 c 3'
*
'set line 3 1 10'
'run drawline_gr2xy.gs 403 48 463 48'
'set line 1 1 1'
'set string 1 l 3'
'run drawstring_gr2xy.gs 468 48 CORE'
'set string 1 c 3'
*
'close 3'
'close 2'
'close 1'
*----------------------------------------------------
'printim kuroshio.png x800 y600'
*====================================================
