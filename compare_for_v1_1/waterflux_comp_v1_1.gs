...
*'d f.6*3.654e5*10.36'
'd f.6*3.654e5'
label(34,15.0,"Evaporation (solid line), Precipitation (dashed line)",30,0,0.12)
...
label(34,2.25,"E-P (= Runoff minus Sublimation)",30,0,0.12)
*label(-5,0,"[Sv]",4,90,0.12)
label(-6,1.1,"10^9 [kg/sec]",4,90,0.12)
label(34,-0.4,"[Year]",30,0,0.12)
*
*'close 7'
'close 6'
'close 5'
...
'print'
'disable print'
'!gxeps -c -i waterflux.gm -o waterflux_comp.eps'
'!rm waterflux.gm'
*====================================================
