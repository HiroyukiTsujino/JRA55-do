...
'reinit'
*------------------------------------------------
'open dswrf_all_glb_jra55_v0_1.ctl'
'open dswrf_all_glb_jra55_v1_1.ctl'
'open dswrf_all_glb_core.ctl'
'open dswrf_all_glb_ceres.ctl'
*
'set vpage 0.0 11.0 0.0 8.5'
'set parea 0.8 5.3 6.0 8.1'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.1'
...
'd f.3'
*
label(34,195.5,"(a) Downward short wave",30,0,0.12)
label(-6.5,184.0,"[W/m2]",4,90,0.10)
...
'close 1'
*-------------------------------------------------
'open dlwrf_all_glb_jra55_v0_1.ctl'
'open dlwrf_all_glb_jra55_v1_1.ctl'
'open dlwrf_all_glb_core.ctl'
'open dlwrf_all_glb_ceres.ctl'
*
'set vpage 0.0 11.0 0.0 8.5'
'set parea 0.8 5.3 3.3 5.4'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.1'
'set ylopts 1 3 0.1'
...
'd f.3'
*
label(34,365.5,"(b) Downward long wave",30,0,0.12)
label(-6.5,355.0,"[W/m2]",4,90,0.10)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'close 4'
...
'close 1'
*---------------------------------------------
'open nswrf_glb_v1_1.ctl'
'open nlwrf_glb_v1_1.ctl'
'open latent_glb_v1_1.ctl'
'open sensible_glb_v1_1.ctl'
*
'open nswrf_glb_v0_1.ctl'
'open nlwrf_glb_v0_1.ctl'
'open latent_glb_v0_1.ctl'
'open sensible_glb_v0_1.ctl'
*
'open nswrf_glb_core.ctl'
'open nlwrf_glb_core.ctl'
'open latent_glb_core.ctl'
'open sensible_glb_core.ctl'
*

'set vpage 0.0 11.0 0.0 8.5'
'set parea 0.8 5.3 0.6 2.7'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.1'
'set ylopts 1 3 0.1'
...
splt(0.0,1,68)
*
label(34,16.5,"(c) TOTAL surface heat flux",30,0,0.12)
label(-6.5,5.0,"[W/m2]",4,90,0.10)
label(34,-8,"[Year]",30,0,0.11)
*
'close 12'
'close 11'
'close 10'
...
'close 1'
*----------------------------------------------------
'open precip_glb_jra55_v0_1.ctl'
'open precip_glb_jra55_v1_1.ctl'
'open precip_glb_core.ctl'
'open precip_glb_gpcp.ctl'
*
'set vpage 0.0 11.0 0.0 8.5'
'set parea 6.2 10.7 6.0 8.1'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.1'
'set ylopts 1 3 0.1'
...
'd f.3*3.654e5'
*
label(34,16.8,"(d) Precipitation",30,0,0.12)
label(-6.5,14.1,"10^9 [kg/sec]",4,90,0.10)
*label(28,-25,"[Year]",30,0,0.12)
*
'close 4'
'close 3'
...
*splt(0.0,1,68)
*
label(34,1.53,"(e) Runoff",30,0,0.12)
*label(-5,0,"[Sv]",4,90,0.12)
label(-6.5,1.25,"10^9 [kg/sec]",4,90,0.10)
*label(34,-0.4,"[Year]",30,0,0.10)
*
'close 2'
'close 1'
*----------------------------------------------------
'open evapor_glb_v0_1.ctl'
'open evapor_glb_v1_1.ctl'
'open evapor_glb_core.ctl'
*
'open precip_glb_jra55_v0_1.ctl'
'open precip_glb_jra55_v1_1.ctl'
'open precip_glb_core.ctl'
...
'set cthick 10'
'set cmark 0'
'd (f.2-f.5)*3.654e5 - runoff.8*1e-9'
*
'set ccolor 3'
'set cthick 10'
'set cmark 0'
*'d (f.3-f.6)*3.654e5*10.36'
'd (f.3-f.6)*3.654e5 -all.7*1e-9'
*
splt(0.0,1,68)
*
label(34,1.15,"(f) E-P-R",30,0,0.12)
*label(-5,0,"[Sv]",4,90,0.12)
label(-6.5,0.0,"10^9 [kg/sec]",4,90,0.10)
label(34,-1.3,"[Year]",30,0,0.10)
*
'close 8'
'close 7'
'close 6'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o flux_comp.eps'
'!rm heatflux.gm'
*====================================================
