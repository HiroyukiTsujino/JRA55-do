...
newdir=../linkdir/work/jra55fcst_v1_2_prcp_3hr_TL319r
...
do
  sed -e s%@item@%${item}% \
      ...
      -e s%@mned@%${mned}% \
      -e s%@dyed@%${dyed}% \
      namelist.calibpcp.monthly_v1_2_update_template > namelist.calibpcp
  ./calib_precip_interannual > calib_v1_2_${item}_update.log
done
