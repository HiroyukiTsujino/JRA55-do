...
newdir=../linkdir/work/jra55fcst_v1_5_3hr_tmp2m_TL319r
...
sed -e s%@yrst@%${yrst}% \
    ...
    -e s%@mned@%${mned}% \
    -e s%@dyed@%${dyed}% \
    namelist.calibsat_ocn_ice_monthly_v1_5_latest_template > namelist.calibsat_ocn_ice

./calib_tmp2m_ocn_ice_interannual > calib_v1_5_tmp2m_latest.log
