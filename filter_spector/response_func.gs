...
'reinit'
*------------------------------------------------
'set vpage 0.00 8.50 5.00 11.00'
'set parea 0.8 7.8 1.0 5.0'
*
'open spector_weight_9p20.ctl'
'open spector_weight_9p50.ctl'
*
'set lon -4.4 -1.9'
'set mproj off'
*'set xlint 0.5'
...
'set xlab on'
'set ylab on'
'set xlevs -4 -3.70 -3.3 -3 -2.69 -2.3 -2'
*'set xlabs 10000 | 5000 | 2000 | 1000 | 500 | 200 | 100'
'set xlopts 1 3 0.0'
'set ylopts 1 3 0.1'
*
'set gxout line'
'set vrange -0.05 1.05'
'set ccolor 2'
'set cthick 10'
'set cmark 0'
'set grads off'
...
'close 1'
*
label(-3.1,  1.1,"Response",30,0,0.14)
label(-4,   -0.1,"10000",9,0,0.10)
label(-3.69,-0.1,"5000",8,0,0.10)
label(-3.3, -0.1,"2000",8,0,0.10)
label(-3,   -0.1,"1000",8,0,0.10)
label(-2.69,-0.1,"500",7,0,0.10)
label(-2.3, -0.1,"200",7,0,0.10)
label(-2  , -0.1,"100",7,0,0.10)
*
'set string 1 l 5'
'run drawstring.gs -1.9 -0.1 (km)'
'set string 1 c 3'
*
label(-3.1,  -0.2,"wave length",12,0,0.12)
*
*--------------
* line legend
*
'set strsiz 0.12'
'set line 2 1 10'
'run drawline.gs -2.8 0.95 -2.5 0.95'
'set line 1 1 1'
'set string 1 l 5'
'run drawstring.gs -2.4 0.95 20-pass'
'set string 1 c 3'
*
'set strsiz 0.12'
'set line 4 1 10'
'run drawline.gs -2.8 0.85 -2.5 0.85'
'set line 1 1 1'
'set string 1 l 5'
'run drawstring.gs -2.4 0.85 50-pass'
'set string 1 c 3'
*
*----------------------------------------------------
'enable print response_func.gm'
'print'
'disable print'
'!gxeps -c -i response_func.gm -o response_func.eps'
'!rm response_func.gm'
*====================================================
