...
'set cthick 2'
'set cmark 1'
'd ave(f.1,lat=-60,lat=-45)*10'
*
'set ccolor 4'
'set cthick 2'
'set cmark 2'
'd ave(f.2,lat=-60,lat=-45)*10'
*
label(25,1.9,"Zonal wind stress (60S-45S average)",30,0,0.12)
*label(-5,-52.5,"[W/m2]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*--------------------------------------------
'set vpage 0.0 8.5 0.0 11.0'
'set parea 0.5 8.0 4.1 7.0'
*
'set lat -80 -25'
'set time jan1948 jan2015'
'set xyrev on'
...
*'draw string 8.0 1.25 [cm]'
 label(35,68.0,"CORE",20,0,0.12)
*'run cbarn2.gs 0.8 0 5.5 5.0 1 2'
*----------------------------------------------------
'set vpage 0.0 8.5 0.0 11.0'
'set parea 0.5 8.0 0.5 3.4'
*
'set lat -80 -25'
'set time jan1948 jan2015'
'set xyrev on'
...
'd f.2*10'
*'draw string 8.0 1.25 [cm]'
 label(25,68.0,"JRA55-DO",20,0,0.12)
*'run cbarn2.gs 0.8 0 5.5 5.0 1 2'
*----------------------------------------------------
'close 2'
'close 1'
