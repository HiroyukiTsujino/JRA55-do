...
'set gxout grfill'
*'run colmap.gs odcm2'
*'run clevsreg.gs -7.5 2.0 0.5'
'run colmap.gs rbb64'
'run clevsreg.gs -3.1 3.1 0.1'
'set grads off'
'd ave(hcurl,time=jan1958,time=dec2009)*1e7'
*
*'set gxout contour'
*'set ccolor 1'
*'set clab off'
...
'd ave(hcurl,time=jan1958,time=dec2009)*1e7'
*
*label(240.0,98.0,"R(`3x`0) QuikSCAT `3$ `0JRA55 (aug1999-jul2009)",30,0,0.15)
label(15.0,-8.0,"WSC (CORE:1958-2009)",30,0,0.12)
*'run cbarn2.gs 0.8 0 4.25 0.5 4 5'
*
'close 1'
*------------------------------------------
...
'close 1'
*------------------------------------------------
'open jra55_hcurl_v0_7.ctl'
*
'set vpage 0.00 11.00 0.00 8.50'
'set parea 4.00  7.00 1.00 7.50'
*
'set lon 5 25'
'set lat -40 -10'
*
...
*
*label(240.0,98.0,"R(`3x`0) QuikSCAT `3$ `0JRA55 (aug1999-jul2009)",30,0,0.15)
label(15.0,-8.0,"WSC (JRA55-do:1958-2009)",30,0,0.12)
*'run cbarn2.gs 0.8 0 5.5 0.5 4 5'
*
'close 1'
*----------------------------------------------------
'open jra_cobe_ocean-mask.ctl'
...
'close 1'
*------------------------------------------------
'open jra55_hcurl_v0_1.ctl'
*
'set vpage 0.00 11.00 0.00 8.50'
'set parea 7.50 10.50 1.00 7.50'
*
'set lon 5 25'
'set lat -40 -10'
*
...
*
*label(240.0,98.0,"R(`3x`0) QuikSCAT `3$ `0JRA55 (aug1999-jul2009)",30,0,0.15)
label(15.0,-8.0,"WSC (JRA55-raw:1958-2009)",30,0,0.12)
'run cbarn2.gs 0.8 0 5.5 0.5 1 5'
*
'close 1'
*--------------------------------------------
'open jra_cobe_ocean-mask.ctl'
...
'close 1'
*----------------------------------------------------
'enable print hcurl_atl.gm'
'print'
'disable print'
'!gxeps -c -i hcurl_atl.gm -o hcurl_atl.eps'
'!rm hcurl_atl.gm'
*====================================================
