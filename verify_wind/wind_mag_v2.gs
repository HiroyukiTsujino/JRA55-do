...
'd wind10mcorr'
*
label(240.0,98.0,"Multiplicative factor for wind speed (v1)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 6.0 1 2'
*
'close 1'
*----------------------------------------------------
'open wind_mag_nov1999-oct2009_antarc_smooth.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
'd wind10mcorr'
*
label(240.0,98.0,"Multiplicative factor for wind speed (v2)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i wind_mag.gm -o wind_mag_v2.eps'
'!rm wind_mag.gm'
*====================================================
