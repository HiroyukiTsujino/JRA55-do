...
'reinit'
*------------------------------------------------
'open wind_mag_nov1999-oct2009_filled.ctl'
*
...
'd wind10mcorr'
*
label(240.0,98.0,"Multiplicative factor for wind speed",30,0,0.15)
...
'd wind10mcorr'
*
label(240.0,98.0,"Smoothed multiplicative factor for wind speed",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i wind_mag.gm -o wind_mag.eps'
'!rm wind_mag.gm'
*====================================================
