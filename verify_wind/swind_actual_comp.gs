...
'set ylint 0.5'
*
'open swind_actual_e1_clim_zm.ctl'
'set lat -90 90'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
...
'set cthick 5'
'set cmark 0'
'd smth9(ave(f,time=nov1999,time=oct2009)) * 1e-2'
'close 1'
*
'open swind_actual_blend_clim_zm.ctl'
'set lat -90 90'
'set ccolor 5'
'set cthick 1'
'set digsiz 0.05'
...
'close 1'
*
*'open wind10m_e4_zm.ctl'
*'set lat -90 90'
*'set ccolor 2'
*'set cthick 5'
*'set cmark 0'
*'d ave(f,time=nov1999,time=oct2009) * 1e-2'
*'close 1'
*
*
'open swind_actual_e3_zm.ctl'
'set lat -90 90'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
...
'close 1'
*
label(0,11.8,"Zonal mean actual wind at 10 m (nov1999-oct2009)",30,0,0.12)
...
'print'
'disable print'
'!gxeps -c -i wind10m_comp.gm -o wind10m_actual_comp.eps'
'!\rm wind10m_comp.gm'
*====================================================
