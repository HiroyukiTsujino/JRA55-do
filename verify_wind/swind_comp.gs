...
'reinit'
*------------------------------------------------
'open wind10m_zm_jra55org.ctl'
'open wind10m_zm_core.ctl'
'open wind10m_zm_qscat.ctl'
'open wind10m_zm_jra55c2.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.0 8.0 6.0 10.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'set cthick 5'
'set cmark 0'
'd ave(f.1,time=nov1999,time=oct2009) * 1e-2'
'set ccolor 3'
'set cthick 5'
'set cmark 0'
'd smth9(ave(f.2,time=nov1999,time=oct2009)) * 1e-2'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
...
'set cthick 5'
'set cmark 0'
'd ave(f.4,time=nov1999,time=oct2009) * 1e-2'
label(0,12.3,"Zonal mean scalar wind at 10 m (nov1999-oct2009)",30,0,0.12)
label(-105,8.0,"[m/s]",4,90,0.12)
...
'print'
'disable print'
'!gxeps -c -i wind10m_comp.gm -o wind10m_comp.eps'
'!\rm wind10m_comp.gm'
*====================================================
