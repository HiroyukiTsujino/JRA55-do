...
'reinit'
*------------------------------------------------
'open wind_rot_ceof_nov1999-oct2009_antarc_smooth.ctl'
*
...
label(205.0,98.0,"Counter-clockwise rotation factor (v0.2)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 0.5 1 5'
*
'close 1'
*------------------------------------------------
'open wind_rot_ceof_monthly_latlon.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
*
*label(240.0,98.0,"R(`3x`0) QuikSCAT `3$ `0JRA55 (aug1999-jul2009)",30,0,0.15)
label(205.0,98.0,"Counter-clockwise rotation factor (v0.3)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i wind_rot.gm -o wind_rot_v0_3.eps'
'!rm wind_rot.gm'
*====================================================
