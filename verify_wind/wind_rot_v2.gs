...
'reinit'
*------------------------------------------------
'open wind_rot_ceof_nov1999-oct2009_smooth.ctl'
*
...
label(240.0,98.0,"Counter-clockwise rotation factor (v1)",30,0,0.15)
...
*
*label(240.0,98.0,"R(`3x`0) QuikSCAT `3$ `0JRA55 (aug1999-jul2009)",30,0,0.15)
label(240.0,98.0,"Rotation factor (v2)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 4 5'
*
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i wind_rot.gm -o wind_rot_v2.eps'
'!rm wind_rot.gm'
*====================================================
