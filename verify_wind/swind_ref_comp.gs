...
'set ylint 0.5'
*
'open swind_actual_anl_clim_zm.ctl'
'set lat -90 90'
'set ccolor 2'
'set cthick 5'
'set cmark 0'
...
*'close 1'
*
'open swind_actual_qscat_zm.ctl'
'set lat -90 90'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
...
'close 1'
*
'open swind_neutral_qscat_zm.ctl'
'set lat -90 90'
'set ccolor 15'
'set cthick 5'
'set cmark 0'
...
'close 1'
*
'open swind_actual_remss_zm.ctl'
'set lat -90 90'
'set ccolor 10'
'set cthick 5'
'set cmark 0'
...
'close 1'
*
label(0,11.8,"Zonal mean scalar wind at 10 m (nov1999-oct2009)",30,0,0.12)
...
'print'
'disable print'
'!gxeps -c -i wind10m_comp.gm -o wind10m_ref_comp.eps'
'!\rm wind10m_comp.gm'
*====================================================
