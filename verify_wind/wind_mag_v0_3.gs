...
'd wind10mcorr'
*
label(205.0,98.0,"Multiplicative factor for wind speed (v0.2)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 6.0 1 2'
*
'close 1'
*----------------------------------------------------
'open wind_mag_tanh_monthly_latlon.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
'd ave(windmag,t=1,t=12)'
*
label(205.0,98.0,"Multiplicative factor for wind speed (v0.3)",30,0,0.15)
