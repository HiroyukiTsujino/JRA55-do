...
flout="${newdir}/sensible_1x1.JRA55v0_1.nc"
flctl="${newdir}/sensible_1x1.JRA55v0_1.ctl"
...
&nml_global_attributes
  global_attributes%title="Sensible heat flux based on the raw atmospheric state of JRA-55"
