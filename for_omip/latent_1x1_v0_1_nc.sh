...
flin="${orgdir}/latent."
flout="${newdir}/latent_1x1.JRA55v0_1.nc"
flctl="${newdir}/latent_1x1.JRA55v0_1.ctl"
...
&nml_global_attributes
  global_attributes%title="Latent heat flux based on the raw atmospheric state of JRA-55"
