...
flin="${orgdir}/evapor."
flout="${newdir}/evapor_1x1.JRA55v0_0.nc"
flctl="${newdir}/evapor_1x1.JRA55v0_0.ctl"
...
&nml_global_attributes
  global_attributes%title="Evaporation flux from the raw JRA-55 product"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.0"
  global_attributes%comment="Flux is estimated by the atmospheric model used by JRA-55"
