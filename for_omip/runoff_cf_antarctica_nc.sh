...
flin="${dataorg}/Depoorter_2013_Antarctica/clim025x025/CF_025x025.dat"
flout="${datanew}/OMIP_DATA/JRA55-do-v1.0/runoff_antarctica_calving_flux_clim.18Nov2016.nc"
flctl="${datanew}/OMIP_DATA/JRA55-do-v1.0/runoff_antarctica_calving_flux_clim.ctl"
...
&nml_global_attributes
  ...
  global_attributes%comment="Climatological annual mean calving water transport from Antarctica of Depoorter et al. (2013) GRL."
