...
flin="${orgdir}/nlwrf."
flout="${newdir}/nlwrf_1x1.JRA55v0_1.nc"
flctl="${newdir}/nlwrf_1x1.JRA55v0_1.ctl"
...
&nml_global_attributes
  global_attributes%title="Surface net shortwave radiation based on the raw JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.1"
  global_attributes%comment="Heat flux is estimated using COBE-SST sst and sea ice"
