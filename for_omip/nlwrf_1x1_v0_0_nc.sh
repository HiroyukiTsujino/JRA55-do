...
flin="${orgdir}/nlwrf."
flout="${newdir}/nlwrf_1x1.JRA55v0_0.nc"
flctl="${newdir}/nlwrf_1x1.JRA55v0_0.ctl"
...
&nml_vars
 ...
 vname_tmp='rlntds'
 vunit_tmp='W/m2',
 vlongname_tmp='Surface Net Downward Longwave Radiation'
 vstandardname_tmp='surface_net_downward_longwave_flux'
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Net longwave radiation of the raw JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.0"
  global_attributes%comment="Heat flux is estimated by the atmosphric model used by JRA-55"
