...
flin="${dataorg}/jra55-do-v1_1-river/runoff_Greenland_Bamber.365dy."
flout="${datanew}/OMIP_DATA/JRA55-do-v1.1/runoff_greenland_clim_365dy.15Dec2016.nc"
flctl="${datanew}/OMIP_DATA/JRA55-do-v1.1/runoff_greenland_clim_365dy.ctl"
...
&nml_global_attributes
  ...
  global_attributes%comment="Climatological runoff from Greenland based on 1961-1990 of Bamber et al. (2012) GRL presented as virtual normal year 2001"
