...
flin="${orgdir}/precip."
flout="${newdir}/precip_1x1.JRA55v0_1.nc"
flctl="${newdir}/precip_1x1.JRA55v0_1.ctl"
...
&nml_global_attributes
  global_attributes%title="Precipitation flux of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.1"
  global_attributes%comment="Flux is based on the raw JRA-55"
