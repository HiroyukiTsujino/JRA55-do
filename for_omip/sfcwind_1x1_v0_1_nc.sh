...
flin="${orgdir}/wind10m."
flout="${newdir}/wind10m_1x1.JRA55v0_1.nc"
flctl="${newdir}/wind10m_1x1.JRA55v0_1.ctl"
...
&nml_global_attributes
  global_attributes%title="Near Surface (10m) wind speed based on the raw atmospheric state of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.1"
  global_attributes%comment="Wind speed is calculated by the atmospheric model used by JRA-55"
