...
flout="${newdir}/sensible_1x1.JRA55v1_5_00.nc"
flctl="${newdir}/sensible_1x1.JRA55v1_5_00.ctl"
...
&nml_global_attributes
  global_attributes%title="Sensible heat flux based on an adjusted atmospheric state of JRA-55"
