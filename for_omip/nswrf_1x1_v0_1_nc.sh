...
flin="${orgdir}/nswrf."
flout="${newdir}/nswrf_1x1.JRA55v0_1.nc"
flctl="${newdir}/nswrf_1x1.JRA55v0_1.ctl"
...
&nml_global_attributes
  ...
  global_attributes%comment="Heat flux is estimated using Large and Yeager (2009) albedo and COBE-SST sea ice"
