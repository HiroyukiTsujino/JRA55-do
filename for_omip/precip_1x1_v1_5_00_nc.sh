...
flin="${orgdir}/precip."
flout="${newdir}/precip_1x1.JRA55v1_5_00.nc"
flctl="${newdir}/precip_1x1.JRA55v1_5_00.ctl"
...
&nml_global_attributes
  global_attributes%title="Adjusted precipitation flux of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v1.5.00"
  global_attributes%comment="CORE interannual forcing version 2 (Large and Yeager 2009) is used to adjust JRA-55"
