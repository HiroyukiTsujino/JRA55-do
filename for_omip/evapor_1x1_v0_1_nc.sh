...
orgdir=../linkdir/verification/jra55fcst_v0_1_monthly_1x1
newdir=../linkdir/products/version_0_1/netCDF_flux

flin="${orgdir}/evapor."
flout="${newdir}/evapor_1x1.JRA55v0_1.nc"
flctl="${newdir}/evapor_1x1.JRA55v0_1.ctl"
...
&nml_global_attributes
  global_attributes%title="Evaporation flux based on the raw atmospheric state of JRA-55"
