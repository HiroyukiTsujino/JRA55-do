...
flout="${datanew}/OMIP_DATA/JRA55-do-v1.1/runoff_antarctica_calving_flux_clim.15Dec2016.nc"
flctl="${datanew}/OMIP_DATA/JRA55-do-v1.1/runoff_antarctica_calving_flux_clim.ctl"
