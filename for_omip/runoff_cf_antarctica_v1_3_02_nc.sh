...
flin="${dataorg}/jra55-do-v1_1-river/river_Antarctica_Depoorter_2013/runoff_Antarctica_Depoorter_CF.gd"
flout="${datanew}/OMIP_DATA/JRA55-do-v1.3.02/runoff_antarctica_calving_flux_clim.16Feb2019.nc"
flctl="${datanew}/OMIP_DATA/JRA55-do-v1.3.02/runoff_antarctica_calving_flux_clim.ctl"
