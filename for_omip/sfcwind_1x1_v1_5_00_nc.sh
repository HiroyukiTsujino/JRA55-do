...
flin="${orgdir}/wind10m."
flout="${newdir}/wind10m_1x1.JRA55v1_5_00.nc"
flctl="${newdir}/wind10m_1x1.JRA55v1_5_00.ctl"
...
&nml_vars
 ...
 vname_tmp='sfcwind'
 vunit_tmp='m s-1',
 vlongname_tmp='Near-Surface (10m) wind speed'
 vstandardname_tmp='wind_speed'
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Near Surface (10m) wind speed based on an adjusted atmospheric state of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v1.5.00"
  global_attributes%comment="Surface wind speed is adjusted using QuikSCAT wind product"
