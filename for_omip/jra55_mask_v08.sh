...
flin="../linkdir/data/jra_mask.gd"
flout="/work116/htsujino/SURF_FLUX/forcing/OMIP_DATA/JRA55_v0.8/jra55_mask_org.30Jun2016.nc"
flctl="/work116/htsujino/SURF_FLUX/forcing/OMIP_DATA/JRA55_v0.8/jra55_mask_org.30Jun2016.ctl"
...
&nml_vars
 ...
 vname_tmp='water',
 vunit_tmp='1',
 vlongname_tmp='Water area fraction with Water(=1) and Land(=0)',
 vstandardname_tmp='water_area_fraction',
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  ...
  global_attributes%comment="In the reduced grid region (>41deg), the mid-point between land and water is set to water (=1)"
