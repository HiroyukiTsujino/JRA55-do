...
flin="../linkdir/data/area_u.gd"
flout="/work116/htsujino/SURF_FLUX/forcing/OMIP_DATA/JRA55_v0.7/jra55_cell_area.30Jun2016.nc"
flctl="/work116/htsujino/SURF_FLUX/forcing/OMIP_DATA/JRA55_v0.7/jra55_cell_area.30Jun2016.ctl"
...
&nml_global_attributes
  global_attributes%title="Grid cell area of JRA55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.7"
  global_attributes%comment="Earth's radius is set to 6375 km for this computation"
