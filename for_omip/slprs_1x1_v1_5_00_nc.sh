...
flin="${orgdir}/slprs_all."
flout="${newdir}/slprs_all_1x1.JRA55v1_5_00.nc"
flctl="${newdir}/slprs_all_1x1.JRA55v1_5_00.ctl"
...
&nml_global_attributes
  global_attributes%title="Sea level pressure based on atmospheric state of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v1.5.00"
  global_attributes%comment="Sea level pressure around erroneous tropical cyclones is replaced by 20CRv3"
