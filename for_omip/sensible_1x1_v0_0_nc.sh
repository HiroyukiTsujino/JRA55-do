...
orgdir=../linkdir/verification/jra55fcst_orgflux_monthly_1x1
newdir=../linkdir/products/version_0_0/netCDF_flux

flin="${orgdir}/sensible."
flout="${newdir}/sensible_1x1.JRA55v0_0.nc"
flctl="${newdir}/sensible_1x1.JRA55v0_0.ctl"
...
&nml_vars
 ...
 vname_tmp='hfss'
 vunit_tmp='W/m2',
 vlongname_tmp='Surface Downward Sensible Heat Flux'
 vstandardname_tmp='surface_downward_sensible_heat_flux'
 rconv_tmp=-1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Sensible heat flux from the raw JRA-55 product"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.0"
  global_attributes%comment="Heat flux is estimated by the atmospheric model used by JRA-55"
