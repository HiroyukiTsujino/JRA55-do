...
orgdir=../linkdir/verification/jra55fcst_v1_5_monthly_1x1
newdir=../linkdir/products/version_1_5/netCDF_flux

flin="${orgdir}/evapor."
flout="${newdir}/evapor_1x1.JRA55v1_5_00.nc"
flctl="${newdir}/evapor_1x1.JRA55v1_5_00.ctl"
...
&nml_vars
 ...
 vname_tmp='evs'
 vunit_tmp='kg/m2/s',
 vlongname_tmp='Water Evaporation Flux Where Ice Free Ocean over Sea'
 vstandardname_tmp='water_evaporation_flux'
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Evaporation flux based on an adjusted atmospheric state of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v1.5.00"
  global_attributes%comment="Flux is estimated using the bulk formula of Large and Yeager (2009)"
