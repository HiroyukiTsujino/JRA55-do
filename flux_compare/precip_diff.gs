...
'reinit'
*------------------------------------------------
'open jra55_precip.ctl'
'open jra55c_precip.ctl'
*
...
'set gxout shaded'
'run colmap.gs rb26'
'run clevsreg.gs -6.0 6.0 0.5'
'set grads off'
'd ave(precip-precip.2,time=jan2001,time=jan2010)*86400'
*
*'set gxout contour'
*'set ccolor 1'
*'set clab off'
...
'd ave(precip-precip.2,time=jan2001,time=jan2010)*86400'
*
label(210.0,98.0,"Precipitation [mm/day] (JRA55-JRA55C) avr2001-2010",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 5.8 0 2'
*
'close 2'
'close 1'
*----------------------------------------------------
'enable print precip_diff.gm'
'print'
'disable print'
'!gxeps -c -i precip_diff.gm -o precip_diff.eps'
'!rm precip_diff.gm'
*====================================================
