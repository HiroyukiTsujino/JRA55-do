...
'reinit'
*------------------------------------------------
'open dlwrf_glb_e4.ctl'
'open dlwrf_glb_core_dec2015.ctl'
...
'd f.2-f.4-55'
*
label(34,353,"Long wave",30,0,0.12)
label(34,351.5,"Downward (solid), Upward (dashed, offset by -45 W/m2)",30,0,0.12)
label(-7,340.0,"[W/m2]",4,90,0.11)
label(34,328,"[Year]",30,0,0.12)
*
'close 4'
'close 3'
'close 2'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o lwupdn_jra55core.eps'
*====================================================
