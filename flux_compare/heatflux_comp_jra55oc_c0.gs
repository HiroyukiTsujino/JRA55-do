...
*
'open nswrf_glb_jra55c_c0.ctl'
'open nlwrf_glb_jra55c_c0.ctl'
'open latent_glb_jra55c_c0.ctl'
'open sensible_glb_jra55c_c0.ctl'
*
...
*'set cmark 9'
'set cmark 0'
'd (f.9+f.10+f.11+f.12)/1000'
*
splt(0.0,1,68)
*
label(32,20,"TOTAL surface heat flux",30,0,0.12)
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o heatflux_jra55c.eps'
*====================================================
