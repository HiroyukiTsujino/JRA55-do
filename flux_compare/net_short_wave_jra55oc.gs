...
*
'open nswrf_srb3_0lp.ctl'
*
'open nswrf_srb3_1.ctl'
*
'open nswrf_ceres.ctl'
*
...
*
*
label(32,182,"Net short wave",30,0,0.12)
label(-7,170.0,"[W/m2]",4,90,0.11)
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o net_sw_jra55oc.eps'
*====================================================
