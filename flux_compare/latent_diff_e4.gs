...
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
'define la90=ave(latent,time=jan1986,time=jan1995)'
'define la05=ave(latent,time=jan2001,time=jan2010)'
*
'set gxout shaded'
...
'd la05-la90'
*
label(210.0,98.0,"Latent heat flux (avr2001-2010) - (avr1986-1995)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i latent_diff.gm -o latent_diff_e4.eps'
'!rm latent_diff.gm'
*====================================================
