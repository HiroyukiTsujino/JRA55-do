...
'reinit'
*------------------------------------------------
'open jra55_latent.ctl'
'open jra55c_latent.ctl'
*
...
'run clevsreg.gs -18 18 2'
*'run colmap.gs rb40'
*'run clevsreg.gs -38 38 2'
'set grads off'
'd -ave(latent-latent.2,time=jan2001,time=jan2005)'
*
*'set gxout contour'
*'set ccolor 1'
*'set clab off'
...
'd -ave(latent-latent.2,time=jan2001,time=jan2005)'
*
label(210.0,98.0,"Latent heat flux (JRA55-JRA55C) avr2001-2005",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i latent_diff.gm -o latent_diff.eps'
'!rm latent_diff.gm'
*====================================================
