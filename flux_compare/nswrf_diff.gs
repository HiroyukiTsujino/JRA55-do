...
'reinit'
*------------------------------------------------
'open jra55_nswrf.ctl'
'open jra55c_nswrf.ctl'
*
...
'set grads off'
'd ave(nswrf-nswrf.2,time=jan2001,time=jan2010)'
*
*'set gxout contour'
*'set ccolor 1'
*'set clab off'
...
'd ave(nswrf-nswrf.2,time=jan2001,time=jan2010)'
*
label(210.0,98.0,"Net short wave (JRA55-JRA55C) avr2001-2010",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 5.8 1 2'
*
'close 2'
'close 1'
*----------------------------------------------------
'enable print nswrf_diff.gm'
'print'
'disable print'
'!gxeps -c -i nswrf_diff.gm -o nswrf_diff.eps'
'!rm nswrf_diff.gm'
*====================================================
