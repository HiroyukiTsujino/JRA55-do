...
*------------------------------------------------
*
'open latent_glb_d5.ctl'
'open sensible_glb_d5.ctl'
*
'open latent_glb_d6.ctl'
*
...
'd f.4'
*
label(30,-84,"Latent heat flux",30,0,0.12)
label(-7,-97.5,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 2.3 4.3'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.5'
*
label(30,-12.0,"Sensible heat flux",30,0,0.12)
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o heatflux_v0_2.eps'
*====================================================
