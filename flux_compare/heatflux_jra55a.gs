...
*
'open hs_q_netsw_ave_ann_jra55a.ctl'
'open hs_q_netlw_ave_ann_jra55a.ctl'
'open hs_q_latent_ave_ann_jra55a.ctl'
'open hs_q_sens_ave_ann_jra55a.ctl'
*
...
'd f.5'
*
label(30,171.5,"Net short wave",30,0,0.12)
label(-5,165.0,"[W/m2]",4,90,0.11)
...
'd f.6'
*
label(30,-51.0,"Net long wave",30,0,0.12)
label(-5,-55.0,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
...
'd f.7'
*
label(30,-85,"Latent heat flux",30,0,0.12)
label(-5,-94.0,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
...
'd f.8'
*
label(30,-11.5,"Sensible heat flux",30,0,0.12)
label(-5,-14.5,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
...
splt(0.0,1,58)
*
label(30,11,"TOTAL surface heat flux",30,0,0.12)
label(-5,3.0,"[W/m2]",4,90,0.11)
label(30,-7,"[Year]",10,0,0.12)
*
'close 8'
'close 7'
'close 6'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o heatflux_jra55a.eps'
*====================================================
