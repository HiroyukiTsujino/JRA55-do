...
'reinit'
*------------------------------------------------
'open evapor_glb_c0_dec2015_10m.ctl'
'open evapor_glb_e4.ctl'
'open evapor_glb_c2.ctl'
'open evapor_glb_core_dec2015.ctl'
*
'open precip_glb_c0_dec2015_10m.ctl'
'open precip_glb_e4.ctl'
'open precip_glb_c2.ctl'
'open precip_glb_core_dec2015.ctl'
*
...
'set ylab on'
'set ylab %.1f'
*'set vrange 12.0 14.8'
'set vrange 12.0 16.0'
'set ylint 0.4'
...
*'d f.6*3.654e5*10.36'
'd f.8*3.654e5'
label(34,16.3,"Evap (solid line) Precip (dashed line)",30,0,0.12)
...
label(34,2.15,"E-P (= Run off minus Sublimation)",30,0,0.12)
*label(-5,0,"[Sv]",4,90,0.12)
label(-6,1.1,"10^9 [kg/sec]",4,90,0.12)
label(34,-0.9,"[Year]",30,0,0.12)
*
'close 8'
'close 7'
'close 6'
...
'print'
'disable print'
'!gxeps -c -i waterflux.gm -o waterflux_jra55_c0_e4.eps'
*====================================================
