...
'set cstyle 3'
'd f.7*3.654e5*10.36'
label(34,17.1,"Evap (solid) Precip (dashed)",30,0,0.12)
*label(28,3.95,"Precip (blue)  Evap (red)",30,0,0.12)
*label(-5,14,"[Sv]",4,90,0.12)
label(-5,14.8,"10^9 [kg/sec]",4,90,0.12)
...
'print'
'disable print'
'!gxeps -c -i waterflux.gm -o waterflux_jra55.eps'
*====================================================
