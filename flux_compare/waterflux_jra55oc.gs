...
'open evapor_glb_org.ctl'
'open evapor_glb_jra55c_org.ctl'
'open evapor_glb_core.ctl'
*
'open precip_glb_c2.ctl'
'open precip_glb_c0.ctl'
'open precip_glb_jra55c_org.ctl'
'open prcp_glb_core.ctl'
*
...
'd f.8*3.654e5*10.36'
*
label(34,17.0,"Evap (solid) Precip (dashed)",30,0,0.12)
label(-5,14.5,"10^9 [kg/sec]",4,90,0.12)
...
'set cthick 5'
'set cmark 0'
'd (f.4-f.8)*3.654e5*10.36'
*label(28,3.5,"E-P",30,0,0.12)
label(34,2.1,"E-P (= Run off minus Sublimation)",30,0,0.12)
*label(-5,0,"[Sv]",4,90,0.12)
label(-5,1.0,"10^9 [kg/sec]",4,90,0.12)
label(34,-0.3,"[Year]",30,0,0.12)
*
'close 8'
'close 7'
'close 6'
...
'print'
'disable print'
'!gxeps -c -i waterflux.gm -o waterflux_jra55oc.eps'
*====================================================
