...
'reinit'
*------------------------------------------------
'open dlwrf_all_glb_c0.ctl'
*
'open dlwrf_all_glb_jra55c_c0.ctl'
*
'open dlwrf_all_glb_core.ctl'
*
'open lwdn_ceres_ocean.ctl'
*
'open lwdn_isccp_ocean.ctl'
*
'open dlwrf_all_glb_c2.ctl'
*
...
*
*
label(34,363,"Downward long wave",30,0,0.12)
label(-7,355.0,"[W/m2]",4,90,0.11)
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o lwdn_jra55oc.eps'
*====================================================
