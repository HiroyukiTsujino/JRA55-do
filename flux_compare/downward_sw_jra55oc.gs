...
'reinit'
*------------------------------------------------
'open dswrf_all_glb_c0.ctl'
*
'open dswrf_all_glb_jra55c_c0.ctl'
*
'open dswrf_all_glb_core.ctl'
*
'open swdn_ceres_ocean.ctl'
*
'open swdn_isccp_ocean.ctl'
*
'open dswrf_all_glb_c2.ctl'
*
...
*
*
label(34,195,"Downward short wave",30,0,0.12)
label(-7,184.0,"[W/m2]",4,90,0.11)
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o swdn_jra55oc.eps'
*====================================================
