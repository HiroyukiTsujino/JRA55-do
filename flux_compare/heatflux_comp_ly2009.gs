...
*
*'open nswrf_glb_org_calib.ctl'
*'open nlwrf_glb_org_calib.ctl'
*'open latent_glb_org_calib.ctl'
*'open sensible_glb_org_calib.ctl'
*
'open nswrf_glb_c0.ctl'
'open nlwrf_glb_c0.ctl'
'open latent_glb_c0.ctl'
'open sensible_glb_c0.ctl'
*
'open nswrf_glb_org.ctl'
'open nlwrf_glb_org.ctl'
'open latent_glb_org.ctl'
'open sensible_glb_org.ctl'
*
...
'd f.15/1000'
*
label(32,-82,"Latent heat flux",30,0,0.12)
label(-7,-97.0,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
...
'd f.16/1000'
*
label(32,-11.0,"Sensible heat flux",30,0,0.12)
label(-7,-16,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
...
'set cthick 5'
'set cmark 0'
'd (f.13+f.14+f.15+f.16)/1000'
*
splt(0.0,1,68)
*
label(32,17,"TOTAL surface heat flux",30,0,0.12)
label(-7,05,"[W/m2]",4,90,0.11)
label(32,-25,"[Year]",30,0,0.12)
*
'close 17'
*
'close 16'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o heatflux_jra55_ly2009.eps'
*====================================================
