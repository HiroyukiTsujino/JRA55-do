...
*
'open nswrf_glb_cobemon_c2.ctl'
'open nlwrf_glb_cobemon_c2.ctl'
'open latent_glb_cobemon_c2.ctl'
'open sensible_glb_cobemon_c2.ctl'
*
'open nswrf_glb_hurrell_c2.ctl'
'open nlwrf_glb_hurrell_c2.ctl'
'open latent_glb_hurrell_c2.ctl'
'open sensible_glb_hurrell_c2.ctl'
*
...
'd f.16/1000'
*
label(32,-11.3,"Sensible heat flux",30,0,0.12)
label(-7,-14.5,"[W/m2]",4,90,0.11)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o heatflux_jra55sst.eps'
*====================================================
