...
'define qjc1=ave(f.4,time=jan1979,time=dec2006)*1000'
'define qjc2=ave(f.5,time=jan1979,time=dec2006)*1000'
'set xlint 15'
'set ylint 0.2'
*
'set ccolor 2'
...
'd qjc2 - qcor'
*
label(0,1.2,"(a) Q10m jra55 - core (1979-2006)",30,0,0.12)
label(-107,0.0,"[g/kg]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 2.4 6.6 5.8 7.8'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
...
'print'
'disable print'
'!gxeps -c -i sph10m_comp.gm -o sph10m_comp.eps'
'!rm sph10m_comp.gm'
*====================================================
