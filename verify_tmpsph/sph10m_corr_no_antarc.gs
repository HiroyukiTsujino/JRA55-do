...
'reinit'
*------------------------------------------------
'open sph10m_ref_core_smooth.ctl'
*
...
'd ave(spfh10m,t=1,t=12)'
*
label(240.0,98.0,"(a) Q10m multiplicative factor (original)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 6.0 4 5'
*
'close 1'
*-------------------------------------------------------------
'open sph10m_ref_core_no_antarc_smooth.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
'd ave(spfh10m,t=1,t=12)'
*
label(240.0,98.0,"(b) Q10m multiplicative factor (new)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i sph10m_comp.gm -o sph10m_corr_no_antarc.eps'
'!rm sph10m_comp.gm'
*====================================================
