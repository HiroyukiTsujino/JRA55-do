...
*-------------------------------------------------------------
*
*'open tmp10m_zm_jra55c0_2m.ctl'
'open tmp10m_zm_jra55c0_10m.ctl'
'open tmp10m_zm_core.ctl'
'open tmp10m_zm_nocs.ctl'
'open tmp10m_zm_jra55e4.ctl'
'open tmp10m_zm_jra55c1.ctl'
*
...
'set vrange -25 30'
'set lat -90 90'
'define tj55=ave(f.1,time=jan1979,time=dec2006)'
'define tcor=ave(f.2,time=jan1979,time=dec2006)'
'define tncs=ave(f.3,time=jan1979,time=dec2006)'
'define tje4=ave(f.4,time=jan1979,time=dec2006)'
'define tjc2=ave(f.5,time=jan1979,time=dec2006)'
'set xlint 15'
'set ylint 5'
*
'set ccolor 2'
...
'set cmark 0'
'd tjc2'
label(0,32.0,"(a) T10m (1979-2006)",30,0,0.12)
label(-107,-0.5,"[`3.`0C]",4,90,0.12)
...
'set cmark 0'
'd tjc2 - tncs'
label(0,0.7,"(b) T10m difference from NOCS (1979-2006)",30,0,0.12)
label(-75,-0.5,"[`3.`0C]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*
'close 5'
'close 4'
...
'close 1'
*----------------------------------------------------
'enable print tmp10m_comp.gm'
'print'
'disable print'
'!gxeps -c -i tmp10m_comp.gm -o tmp10m_comp_e4.eps'
'!rm tmp10m_comp.gm'
*====================================================
