...
'reinit'
*------------------------------------------------
'open sph2m_corr_latlon.1979_1998.ctl'
*
...
'd ave(corr_sph,t=1,t=12)'
*
label(205.0,98.0,"Multiplicative factor for tmp2m adjusted sph2m (v0_3)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i sph2m_corr.gm -o sph2m_corr_v0_3.eps'
'!rm sph2m_corr.gm'
*====================================================
