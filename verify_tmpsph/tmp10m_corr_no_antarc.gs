...
'reinit'
*------------------------------------------------
'open tmp10m_ref_core_smooth.ctl'
*
...
'd ave(tmp10m_corr,t=1,t=12)'
*
label(240.0,98.0,"(a) T10m offset factor (original)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 4'
*
'close 1'
*-------------------------------------------------------------
'open tmp10m_ref_core_no_antarc_smooth.ctl'
...
'd ave(tmp10m_corr,t=1,t=12)'
*
label(240.0,98.0,"(b) smoothed T10m offset factor (new)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 4'
*
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i tmp10m_comp.gm -o tmp10m_corr_no_antarc.eps'
'!rm tmp10m_comp.gm'
*====================================================
