...
*-------------------------------------------------------------
*
*'open sph10m_zm_jra55c0_2m.ctl'
'open sph10m_zm_jra55c0_10m.ctl'
'open sph10m_zm_core.ctl'
'open qair_zm_nocs.ctl'
'open sph10m_zm_jra55c2.ctl'
'open sph10m_zm_jra55e4.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.0 8.0 7.0 10.5'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
...
'set vrange 0 20'
'set lat -90 90'
'define qj55=ave(f.1,time=jan1979,time=dec2006)*1000'
'define qcor=ave(f.2,time=jan1979,time=dec2006)*1000'
'define qncs=ave(f.3,time=jan1979,time=dec2006)'
'define qjc2=ave(f.4,time=jan1979,time=dec2006)*1000'
'define qje4=ave(f.5,time=jan1979,time=dec2006)*1000'
'set xlint 15'
'set ylint 1'
*
'set ccolor 2'
...
'd qjc2'
*
label(0,21.2,"(a) Q10m (1979-2006)",30,0,0.12)
label(-107,10.0,"[g/kg]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 2.4 6.6 3.8 5.8'
*
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
...
'd qjc2 - qncs'
*
label(0,0.7,"(b) Q10m difference from NOCS (1979-2006)",30,0,0.12)
label(-75,-0.5,"[g/kg]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*
'close 5'
'close 4'
...
'close 1'
*----------------------------------------------------
'enable print sph10m_comp.gm'
'print'
'disable print'
'!gxeps -c -i sph10m_comp.gm -o sph10m_comp_e4.eps'
'!rm sph10m_comp.gm'
*====================================================
