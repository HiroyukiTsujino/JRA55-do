...
'd ave(spfh10m,t=1,t=12)'
*
label(240.0,98.0,"(a) Q10m multiplicative factor",30,0,0.15)
...
'd ave(spfh10m,t=1,t=12)'
*
label(240.0,98.0,"(b) Smoothed Q10m multiplicative factor",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i sph10m_comp.gm -o sph10m_corr.eps'
'!rm sph10m_comp.gm'
*====================================================
