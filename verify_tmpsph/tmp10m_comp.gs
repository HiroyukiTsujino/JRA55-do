...
'define tjc4=ave(f.4,time=jan1979,time=dec2006)'
'set xlint 15'
'set ylint 0.5'
*
'set ccolor 2'
...
'set cmark 0'
'd tjc4 - tcor'
label(0,2.0,"(a) T10m JRA55 minus CORE (1979-2006)",30,0,0.12)
...
'define tcor=ave(f.2,time=jan1979,time=dec2006)'
'define tncs=ave(f.3,time=jan1979,time=dec2006)'
'define tjc1=ave(f.4,time=jan1979,time=dec2006)'
'set xlint 15'
'set ylint 0.2'
*
'set ccolor 2'
...
'print'
'disable print'
'!gxeps -c -i tmp10m_comp.gm -o tmp10m_comp.eps'
'!rm tmp10m_comp.gm'
*====================================================
