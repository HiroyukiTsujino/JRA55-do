...
'd ave(tmp10m_corr,t=1,t=12)'
*
label(205.0,98.0,"(a) T10m offset factor (v0_2)",30,0,0.15)
...
'd ave(tmp10m_corr,t=1,t=12)'
*
label(0.0,35.0,"(b) T10m offset factor for Arctic (v0_2)",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i tmp10m_comp.gm -o tmp10m_corr_v0_2.eps'
'!rm tmp10m_comp.gm'
*====================================================
