...
'reinit'
*------------------------------------------------
'open tmp2m_all_corr.1979_1998.ctl'
*
...
'd ave(tmp2m,t=1,t=12)'
*
label(240.0,98.0,"(a) T2m offset factor (v0.3)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 4'
*
'close 1'
*-------------------------------------------------------------
'open tmp2m_ice_corr.1979_1998.ctl'
...
'd ave(tmp2m,t=1,t=12)'
*
label(0.0,35.0,"(b) T2m offset factor over sea ice (v0.3)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 4'
*
'close 1'
*----------------------------------------------------
