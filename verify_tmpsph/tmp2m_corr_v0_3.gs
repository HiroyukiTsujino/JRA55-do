...
'reinit'
*------------------------------------------------
'open tmp2m_all_corr_v0_3.1979_1998.ctl'
*
...
'd ave(tmp2m,t=1,t=12)'
*
label(205.0,98.0,"(c) T2m offset factor on water/land (v0_3)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
*
'close 1'
*-------------------------------------------------------------
'open tmp2m_ice_corr_v0_3.1979_1998.ctl'
...
'd ave(tmp2m,t=1,t=12)'
*
label(0.0,35.0,"(d) T2m offset factor on sea ice (v0_3)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
*
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i tmp2m_corr.gm -o tmp2m_corr_v0_3.eps'
'!rm tmp2m_corr.gm'
*====================================================
