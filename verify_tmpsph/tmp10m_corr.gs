...
'd ave(tmp10m_corr,t=1,t=12)'
*
label(240.0,98.0,"(a) T10m offset factor",30,0,0.15)
...
'd ave(tmp10m_corr,t=1,t=12)'
*
label(240.0,98.0,"(b) smoothed T10m offset factor",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 4'
*
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i tmp10m_comp.gm -o tmp10m_corr.eps'
'!rm tmp10m_comp.gm'
*====================================================
