...
#file_in_base=../linkdir/CORE/core_cobesst_annual_jan2017
file_in_base=../linkdir/CORE/core_cobesst_annual_aug2017
file_out_base=fulldiv
...
fileo=${item}-core-${file_region[${region_number}]}
filectl=${item}-core-${file_region[${region_number}]}.ctl
