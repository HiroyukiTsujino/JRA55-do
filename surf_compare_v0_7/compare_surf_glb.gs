...
'reinit'
*------------------------------------------------
'open wvn10m_glb_v0_1.ctl'
'open wvn10m_glb_core.ctl'
'open wvn10m_glb_v0_7_2.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 7.5 10.3'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.2'
*
label(34,8.05,"10 m neutral wind",30,0,0.14)
...
'open sph10m_glb_core.ctl'
'open sph10m_glb_v0_7_2.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 4.0 6.8'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.2*1000'
*
label(34,11.55,"10 m Specific humidity",30,0,0.14)
label(-7,11.0,"[g/kg]",4,90,0.11)
*label(34,16.2,"[Year]",30,0,0.12)
*
'close 3'
'close 2'
'close 1'
...
'open tmp10m_glb_core.ctl'
'open tmp10m_glb_v0_7_2.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 0.5 3.3'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.2'
*
label(34,17.1,"10 m air temperature",30,0,0.14)
