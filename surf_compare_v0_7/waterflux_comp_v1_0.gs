...
*'d f.6*3.654e5*10.36'
'd f.6*3.654e5'
label(34,15.0,"Evap (solid line) Precip (dashed line)",30,0,0.12)
...
label(34,2.25,"E-P (= Run off minus Sublimation)",30,0,0.12)
...
'print'
'disable print'
'!gxeps -c -i waterflux.gm -o waterflux_jra55_v1_0.eps'
*====================================================
