...
!-----------------------------------------------------------------
  ...
  write(6,*) ' Total day = ', total_day

  do k = 1, klev
    do j = 1, jmax
      do i = 1, imax
        if (nvalid_cl(i,j,k) == total_day) then
