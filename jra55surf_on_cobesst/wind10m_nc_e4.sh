...
flin="${orgdir}/wind10m."
flout="${newdir}/wind10m.JRA55v0_3.nc"
flctl="${newdir}/wind10m.JRA55v0_3.ctl"
...
&nml_vars
 ...
 vname_tmp='sfcWind'
 vunit_tmp='m/s',
 vlongname_tmp='Wind Speed at the 10 meter height'
...
&nml_global_attributes
  global_attributes%title="Adjusted wind speed at 10 meter height of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.3"
  global_attributes%comment="JRA-55 wind field is adjusted using a blended field of QuikSCAT and JRA55 surface analysis"
