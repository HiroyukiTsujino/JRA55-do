...
flin="${orgdir}/sph2m."
flout="${newdir}/sph2m.JRA55v0_3.nc"
flctl="${newdir}/sph2m.JRA55v0_3.ctl"
...
&nml_vars
 ...
 vname_tmp='huss'
 vunit_tmp='kg/kg',
 vlongname_tmp='Specific Humidity at the 2 meter height'
...
&nml_global_attributes
  global_attributes%title="Adjusted specific humidity at 2 meter height of JRA-55"
