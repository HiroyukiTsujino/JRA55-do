...
flin="${orgdir}/rlh2m."
flout="${newdir}/rlh2m.JRA55v0_1.nc"
flctl="${newdir}/rlh2m.JRA55v0_1.ctl"
...
&nml_vars
 ...
 vname_tmp='hurs'
 vunit_tmp='%',
 vlongname_tmp='Relative Humidity at the 2 meter height'
 vstandardname_tmp='relative_humidity'
 rconv_tmp=1.0e2,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Unadjusted relative humidity at 2 meter height of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.1"
  global_attributes%comment="Properties of moist air are computed using the formulae given by Gill (1982)"
