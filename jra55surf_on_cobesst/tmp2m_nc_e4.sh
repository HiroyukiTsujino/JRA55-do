...
flin="${orgdir}/tmp2m."
flout="${newdir}/tmp2m.JRA55v0_3.nc"
flctl="${newdir}/tmp2m.JRA55v0_3.ctl"
...
&nml_vars
 ...
 vlongname_tmp='Air Temperature at the 2 meter height'
...
&nml_global_attributes
  global_attributes%title="Adjusted air temperature at 2 meter height of JRA-55"
