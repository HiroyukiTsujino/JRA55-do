...
flin="${orgdir}/v10m."
flout="${newdir}/v10m.JRA55v0_3.nc"
flctl="${newdir}/v10m.JRA55v0_3.ctl"
...
&nml_vars
 ...
 vname_tmp='vas'
 vunit_tmp='m/s',
 vlongname_tmp='Northward Wind at the 10 meter height'
...
&nml_global_attributes
  global_attributes%title="Adjusted northward wind at 10 meter height of JRA-55"
