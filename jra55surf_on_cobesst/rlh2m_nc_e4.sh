...
flin="${orgdir}/rlh2m."
flout="${newdir}/rlh2m.JRA55v0_3.nc"
flctl="${newdir}/rlh2m.JRA55v0_3.ctl"
...
&nml_global_attributes
  global_attributes%title="Adjusted relative humidity at 2 meter height of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.3"
  global_attributes%comment="JRA-55 surface field is adjusted using JRA55 surface analysis"
