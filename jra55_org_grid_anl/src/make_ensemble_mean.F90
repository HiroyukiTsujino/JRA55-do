...
program make_ensemble_mean
  ...
  namelist /nml_make_ensemble_mean/   &
       & num_ens,                     &
       & nbyr, neyr,                  &
       & file_mask,                   &
       & file_ice_base,               &
  ...
  open(lun,file='namelist.make_ensemble_mean')
  read(lun,nml=nml_make_ensemble_mean)
  close(lun)
...
end program make_ensemble_mean
