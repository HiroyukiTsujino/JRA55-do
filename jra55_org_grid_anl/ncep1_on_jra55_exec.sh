...
reanl_dir='../linkdir/NCEP_R1/grads_monthly'
reanl_jra='../linkdir/forcing/ncep1_monthly_TL319r'
reanl_jra_latlon='../linkdir/forcing/ncep1_monthly_TL319'
jra_cnst='../linkdir/forcing/jra_org/const'
reanl_cnst='../linkdir/NCEP_R1/grads_const'
file_mxe_reanl='NAMELIST.MXE.NCEP1'
file_mask_reanl='lsmask.gd'
l_little_in=.false.

if [ "x${item_reanl}" = "xsph2m" ]; then
  scale_in=1.d-3
  offset_in=0.0d0
else
  scale_in=1.d0
