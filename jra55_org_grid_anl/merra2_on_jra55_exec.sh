...
reanl_dir='../linkdir/MERRA2/grads_monthly'
reanl_jra='../linkdir/forcing/merra2_monthly_TL319r'
reanl_jra_latlon='../linkdir/forcing/merra2_monthly_TL319'
jra_cnst='../linkdir/forcing/jra_org/const'
reanl_cnst='../linkdir/MERRA2/grads_const'
file_mxe_reanl='NAMELIST.MXE.MERRA2'
