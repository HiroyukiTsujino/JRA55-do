...
reanl_dir='../linkdir/NCEP_CFSR/grads_monthly'
reanl_jra='../linkdir/forcing/ncep_cfsr_monthly_TL319r'
reanl_jra_latlon='../linkdir/forcing/ncep_cfsr_monthly_TL319'
jra_cnst='../linkdir/forcing/jra_org/const'
reanl_cnst='../linkdir/NCEP_CFSR/grads_monthly'
file_mxe_reanl='NAMELIST.MXE.NCEPC'
#file_mask_reanl='frocean.gd'
l_little_in=.true.
