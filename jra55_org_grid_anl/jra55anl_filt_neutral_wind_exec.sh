...
out_latlon=.false.
adjust_icesurf=.false.

fcst_org='../linkdir/forcing/jra_org'
fcst_wind='../linkdir/forcing/jra55anl_filt_6hr_TL319r'
fcst_tmp='../linkdir/forcing/jra55anl_6hr_TL319r'
fcst_sph='../linkdir/forcing/jra55anl_6hr_TL319r'
fcst_wind_out='../linkdir/forcing/jra55anl_filt_6hr_TL319r'
fcst_wind_latlon='../linkdir/forcing/jra55anl_filt_6hr_TL319'
