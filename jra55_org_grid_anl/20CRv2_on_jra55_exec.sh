...
reanl_dir='../linkdir/20CRv2/grads_monthly'
reanl_jra='../linkdir/forcing/20CRv2_monthly_TL319r'
reanl_jra_latlon='../linkdir/forcing/20CRv2_monthly_TL319'
jra_cnst='../linkdir/forcing/jra_org/const'
reanl_cnst='../linkdir/20CRv2/grads_const'
file_mxe_reanl='NAMELIST.MXE.20CRv2'
