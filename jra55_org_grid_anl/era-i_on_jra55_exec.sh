...
reanl_dir='../linkdir/ERA-interim/grads_monthly'
reanl_jra='../linkdir/forcing/erai_monthly_TL319r'
reanl_jra_latlon='../linkdir/forcing/erai_monthly_TL319'
jra_cnst='../linkdir/forcing/jra_org/const'
reanl_cnst='../linkdir/ERA-interim/data'
file_mxe_reanl='NAMELIST.MXE.ERAI'
file_mask_reanl='mask.gd'
l_little_in=.false.
