...
jra_dir=../linkdir/forcing/jra55fcst_v1_3_prod3_monthly_TL319
...
corr_dir=../linkdir/forcing/jra55fcst_corrfac_v1_3_01_prod3_TL319
...
do
  ...
  do
    ...
    sed -e s%@jra_dir@%${jra_dir}% \
        ...
        namelist.smooth_tmp_icefree_v1_3_template > namelist.smooth_tmp_icefree
    ...
    sed -e s%@jra_dir@%${jra_dir}% \
        ...
        -e s%@iter_ocean@%${iter_ocean}% \
        -e s%@iter_all@%${iter_all}% \
        namelist.smooth_sph_icefree_v1_3_template > namelist.smooth_tmp_icefree
    ./smooth_tmp_anom_icefree_ocean
