! -*-F90-*-
!==============================================================
program make_correction_for_wind_magnitude
!==============================================================
...
!-----------------------------------------------------------------
  ...
  open (10,file='namelist.windmagcorrec')
  read (10,nml_windmagcorrec) 
  close(10)
...
end program make_correction_for_wind_magnitude
