...
program smooth_correction_factor
  ...
  namelist /nml_smooth_windmag/ flnin, undef_in, flnot, ndata, itermax, &
       & l_apply_mask, fill_value, low_trans, high_trans
  open (11,file='namelist.smooth_windmag')
  read (11,nml=nml_smooth_windmag)
  close(11)
