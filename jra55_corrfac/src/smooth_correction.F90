...
program smooth_correction_factor
  ...
  type(type_libmxe_para) :: para, orgp
  type(type_libmxe_grid) :: grid, orgg
  ...
  namelist /nml_smooth_correc/ flnin, undef_in, flnot, ndata, itermax, &
       & l_apply_mask, fill_value
  open (11,file='namelist.smooth_correction')
  read (11,nml=nml_smooth_correc)
  close(11)
