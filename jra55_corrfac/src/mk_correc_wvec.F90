! -*-F90-*-
!==============================================================
program make_correction_for_wind_vector
!==============================================================
...
!-----------------------------------------------------------------
  ...
  open (10,file='namelist.windcorrec')
  read (10,nml_windcorrec) 
  close(10)
...
!-------
  ...
  write(mtot2,rec=2) real(angle_obs(1:imax,1:jmax),4)
  write(mtot2,rec=3) real(angle_jra(1:imax,1:jmax),4)
  close(mtot2)

end program make_correction_for_wind_vector
