...
jra_dir=../linkdir/forcing/jra55fcst_v7_prod3_monthly_TL319
...
corr_dir=../linkdir/forcing/jra55fcst_corrfac_v7_prod3_TL319
...
do
  ...
  do
    ...
    sed -e s%@jra_dir@%${jra_dir}% \
        ...
        -e s%@iter_ocean@%${iter_ocean}% \
        -e s%@iter_all@%${iter_all}% \
        namelist.smooth_sph_icefree_template > namelist.smooth_tmp_icefree
    ./smooth_tmp_anom_icefree_ocean
