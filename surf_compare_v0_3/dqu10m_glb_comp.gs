...
'reinit'
*------------------------------------------------
'open dqu10m_glb_e4.ctl'
'open dqu10m_glb_core.ctl'
*
...
'd f.2*1000'
*
label(34,4.05,"dq (global average)",30,0,0.12)
label(-7,3.65,"[g/kg]",4,90,0.11)
label(34,3.2,"[Year]",30,0,0.12)
*
'close 2'
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o dqu10m_glb.eps'
'!\rm heatflux.gm'
*====================================================
