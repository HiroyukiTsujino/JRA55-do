...
'reinit'
*------------------------------------------------
'open sph10m_20S20N_e4.ctl'
'open sph2m_20S20N_e4.ctl'
'open sph2m_20S20N_oaflux.ctl'
'open sph10m_20S20N_core.ctl'
*
...
'd f.4*1000'
*
label(34,18.0,"specific humidity (avr 20S-20N)",30,0,0.12)
label(-7,17.0,"[g/kg]",4,90,0.11)
label(34,15.8,"[Year]",30,0,0.12)
*
'set vpage 0.0 8.5 0.0 11.0'
...
splt(0.0,1,68)
*
label(34,0.55,"JRA55v0.3 - OAflux (2 m specific humidity) (avr 20S-20N)",30,0,0.12)
label(-7,0.15,"[g/kg]",4,90,0.11)
label(34,-0.28,"[Year]",30,0,0.12)
*
*
'close 4'
'close 3'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o sph_20S20N.eps'
'!\rm heatflux.gm'
*====================================================
