...
'reinit'
*------------------------------------------------
'open wind10m_glb_c0.ctl'
'open wind10m_glb_jra55c.ctl'
'open wind10m_glb_core.ctl'
'open wind10m_glb_erai.ctl'
*
...
'd f.3/100'
*
label(34,7.72,"10 m wind speed (global average)",30,0,0.12)
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o wind10m_glb_comp.eps'
'!\rm heatflux.gm'
*====================================================
