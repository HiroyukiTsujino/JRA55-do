...
'reinit'
*------------------------------------------------
'open sst_cobe_glb.ctl'
'open tmp10m_glb_e4.ctl'
'open tmp10m_glb_core.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 7.0 10.0'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.3'
*
label(30,17.1,"Globally averaged SST and 10 m air temperature",30,0,0.12)
label(-5,16.4,"[degC]",4,90,0.11)
label(30,15.6,"[Year]",30,0,0.12)
*
*
'close 3'
'close 2'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o sst_tmp10m.eps'
*====================================================
