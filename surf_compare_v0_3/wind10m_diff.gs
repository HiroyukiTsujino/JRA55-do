...
'reinit'
*------------------------------------------------
'open wind10m_jra55.ctl'
'open wind10m_jra55c.ctl'
*
...
'set grads off'
'd ave(wind10m.1-wind10m.2,time=jan2001,time=jan2005)'
*
*'set gxout contour'
*'set ccolor 1'
*'set clab off'
...
'd ave(wind10m.1-wind10m.2,time=jan2001,time=jan2005)'
*
label(210.0,98.0,"10 m wind speed [m/s] (JRA55-JRA55C) avr2001-2005",30,0,0.14)
'run cbarn2.gs 0.8 0 4.25 5.8 0 2'
*
'close 2'
'close 1'
*----------------------------------------------------
'enable print wind_diff.gm'
'print'
'disable print'
'!gxeps -c -i wind_diff.gm -o wind_diff.eps'
'!rm wind_diff.gm'
*====================================================
