...
'reinit'
*------------------------------------------------
'open dqu10m_20S20N_e4.ctl'
'open dqu10m_20S20N_core.ctl'
*
...
'd f.2*1000'
*
label(34,6.0,"dq (avr 20S-20N)",30,0,0.12)
label(-7,5.4,"[g/kg]",4,90,0.11)
label(34,4.65,"[Year]",30,0,0.12)
*
'close 2'
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o dqu10m_20S20N.eps'
'!\rm heatflux.gm'
*====================================================
