...
'reinit'
*------------------------------------------------
'open latent_20S20N_e4.ctl'
'open latent_20S20N_core.ctl'
'open latent_20S20N_oaflux.ctl'
*
...
'd f.2'
*
label(34,-106.0,"latent heat flux (avr 20S-20N)",30,0,0.12)
label(-7,-122.0,"[W/m2]",4,90,0.11)
label(34,-140.0,"[Year]",30,0,0.12)
*
*
'close 4'
'close 3'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o latent_20S20N.eps'
'!\rm heatflux.gm'
*====================================================
