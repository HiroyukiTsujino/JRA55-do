...
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
'define la90=ave(latent,time=jan1980,time=dec1996)'
'define la05=ave(latent,time=jan1998,time=dec2014)'
*'define la90=ave(latent,time=jan1986,time=dec1995)'
*'define la05=ave(latent,time=jan2001,time=dec2010)'
*
'set gxout shaded'
'run colmap.gs bluered'
'run clevsreg.gs -22.5 22.5 2.5'
*'run colmap.gs rb40'
*'run clevsreg.gs -38 38 2'
'set grads off'
'd la05-la90'
*
'set gxout contour'
...
'd la05-la90'
*
label(210.0,98.0,"Latent heat flux (avr1998-2014) - (avr1980-1996)",30,0,0.15)
'run cbarn2.gs 0.9 0 4.25 5.8 1 2'
*
*----------------------------------------------------
'close 1'
*------------------------------------------------
'open jra55_wind10m_e4.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
'set parea 1.00 8.00 1.0 5.0'
*
'set lon 30 390'
*
'set xlint 30'
...
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
'define la90=ave(wind10m,time=jan1980,time=dec1996)/100'
'define la05=ave(wind10m,time=jan1998,time=dec2014)/100'
*
'set gxout shaded'
'run colmap.gs rb26'
'run clevsreg.gs -1.2 1.2 0.1'
*'run colmap.gs rb40'
*'run clevsreg.gs -38 38 2'
'set grads off'
'd la05-la90'
...
'd la05-la90'
*
label(210.0,98.0,"10 m wind (avr1998-2014) - (avr1980-1996)",30,0,0.15)
'run cbarn2.gs 0.9 0 4.25 0.5 2 5'
*
*----------------------------------------------------
'close 1'
'enable print latent_diff.gm'
'print'
'disable print'
'!gxeps -c -i latent_diff.gm -o latent_diff_wind_e4.eps'
'!rm latent_diff.gm'
*====================================================
