...
'reinit'
*------------------------------------------------
'open dtu10m_glb_e4.ctl'
'open dtu10m_glb_e4_hurrell.ctl'
'open dtu10m_glb_core.ctl'
*
...
'd f.3'
*
label(34,1.45,"SST - T(10m)",30,0,0.12)
label(-6,1.1,"[K]",4,90,0.11)
label(34,0.7,"[Year]",30,0,0.12)
*
'close 3'
'close 2'
'close 1'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o dtu10m_comp.eps'
'!\rm heatflux.gm'
*====================================================
