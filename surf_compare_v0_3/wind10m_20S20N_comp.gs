...
'reinit'
*------------------------------------------------
'open wind10m_20S20N_jra55_c0.ctl'
'open wind10m_20S20N_jra55c.ctl'
'open wind10m_20S20N_core.ctl'
'open wind10m_20S20N_erai.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 3.0 10.0'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.3/100'
*
label(34,6.90,"10 m wind speed (avr 20S-20N)",30,0,0.12)
label(-7,6.35,"[m/s]",4,90,0.11)
label(34,5.55,"[Year]",30,0,0.12)
*
*
'close 4'
'close 3'
...
'print'
'disable print'
'!gxeps -c -i heatflux.gm -o wind10m_20S20N_comp.eps'
'!\rm heatflux.gm'
*====================================================
