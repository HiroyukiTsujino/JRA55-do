...
fcst_clim=../linkdir/forcing/jra55fcst_v1_2a_monclim_TL319r

sed -e s%@period_ref@%${period_ref}% \
    -e s%@period_trg@%${period_trg}% \
    -e s%@fcst_clim@%${fcst_clim}% \
    -e s%@l_apply_mask@%${apply_mask}% \
    namelist.make_sph2m_fcst_correc_v1_2_filt_template > namelist.make_sph2mcorrec
./mk_correc_sph2m
...
fcst_clim=../linkdir/forcing/jra55Cfcst_v1_2a_monclim_TL319r
