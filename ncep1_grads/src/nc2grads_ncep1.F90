...
program read_netcdf_output_grads
  ...
  integer(4), parameter :: start_year = 1948
  ...
  real(4),parameter :: undef_ncep1 = -9.96921e36
  ...
  open (10,file='namelist.ncep1_surf')
  read (10,nml=nml_ncep1_surf)
  close(10)
