...
'open evapor-do-v1_3-'region.i'.ctl'
'open evapor-core-'region.i'.ctl'

'open precip-raw-v1_0-'region.i'.ctl'
'open precip-do-v1_3-'region.i'.ctl'
...
*--
rc = writebars(t1, t2, lonbase.i, latbase.i, rarea.i, 0, i)
*
...
'print'
'disable print'
'!gxeps -c -i wflux.gm -o wflux_region.eps'
'!rm wflux.gm'
*
*==============================================================
function writebars  ( argv1, argv2, argv3, argv4, argv5, argv6, argv7 )
*--------------------------------------------------------------
...
lon1=lon1+dlon
rc = setAREAnum (t1, t2, 8, 9)
*rc = drawLineMark( lon1, lat1, _finvdif*area*10, 4, opt1, 8, 0.1)
rc = drawLineMark( lon1, lat1, _finvdif*10, 2, opt1, 8, 0.1)
