...
'reinit'
*------------------------------------------------
'open  nextxy_wo_lake_big_endian_noyrev_lon0strt_rm_GAC_add_Bamber_2018.ctl'
*
...
'd nextx'
*
label(305.0,86.5,"Grid points where Bamber et al. (2018) is used",30,0,0.14)
*
'close 1'
*----------------------------------------------------
'enable print tmp.gm'
'print'
'disable print'
'!gxeps -c -i tmp.gm -o replace_with_bamber_2018.eps'
'!rm tmp.gm'
*====================================================
