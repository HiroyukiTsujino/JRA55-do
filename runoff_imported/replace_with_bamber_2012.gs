...
'reinit'
*------------------------------------------------
'open nextxy_wo_lake_big_endian_noyrev_lon0strt_rm_GA_add_Bamber_2012_v1_3_1.ctl'
*
'set vpage 0.00 11.00 0.00 8.50'
'set parea 0.50 5.00  1.50 7.50'
*
'set lon 280 360'
'set lat 55 85'
'set xlint 10'
...
'd nextx'
*
label(320.0,86.5,"Where Bamber et al. (2012) is used for v1.3.1",30,0,0.12)
*
'close 1'
*------------------------------------------------
'open nextxy_wo_lake_big_endian_noyrev_lon0strt_rm_GA_add_Bamber_2012_v1_3_2.ctl'
*
'set vpage 0.00 11.00 0.00 8.50'
'set parea 6.00 10.50  1.50 7.50'
*
'set lon 280 360'
'set lat 55 85'
'set xlint 10'
...
'd nextx'
*
label(320.0,86.5,"Where Bamber et al. (2012) is used for v1.3.2",30,0,0.12)
*
'close 1'
*----------------------------------------------------
'enable print tmp.gm'
'print'
'disable print'
'!gxeps -c -i tmp.gm -o replace_with_bamber_2012.eps'
'!rm tmp.gm'
*====================================================
