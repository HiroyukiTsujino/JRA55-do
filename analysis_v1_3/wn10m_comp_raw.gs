...
'reinit'
*-----------------------------------
'open wn10m.v1_2tq.nov1999_oct2009.anncl.ctl'
*
...
'set cthick 2'
'd swind'
 label(215.0,17.0,"Wind speed JRA55-raw (nov1999-oct2009) CI=0.5",30,0,0.14)
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o wn10m_jra55raw.eps'
'!rm -f hflux.gm'
*====================================================
