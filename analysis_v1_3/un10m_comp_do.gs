...
'set gxout shaded'
'run colmap.gs odcm2'
'run clevsreg.gs -9.5 0.0 0.5'
'set grads off'
'd ave(un10m.1,time=nov1999,time=oct2009)'
*
'set gxout contour'
'set ccolor 1'
'set clab on'
...
'set cthick 2'
'd ave(un10m.1,time=nov1999,time=oct2009)'
 label(215.0,17.0,"Zonal wind JRA55-do (nov1999-oct2009) CI=0.5",30,0,0.14)
*'draw string 8.0 1.25 [cm]'
'run cbarn2.gs 0.85 0 4.25 6.0 1 2'
'close 1'
*----------------------------------------------------
'open qscat_wind_monthly.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
'run clevsreg.gs -9.5 0.0 0.5'
'set grads off'
'd ave(uwind,time=nov1999,time=oct2009)'
*
'set gxout contour'
'set ccolor 1'
'set clab on'
...
'set cthick 2'
'd ave(uwind,time=nov1999,time=oct2009)'
 label(215.0,17.0,"Zonal wind QuikSCAT (nov1999-oct2009) CI=0.5",30,0,0.14)
'set strsiz 0.08'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o un10m_jra55do.eps'
'!rm -f hflux.gm'
*====================================================
