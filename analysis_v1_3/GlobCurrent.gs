...
'set ylopts 1 3 0.12'
*
*'define globcurru=ave(u,time=01nov1999,time=31oct2009)'
*
*
'set gxout shaded'
'run colmap.gs bluered'
'run clevsreg.gs -0.9 0.9 0.1'
'set grads off'
*'d globcurru'
'd usurf'
*
...
'd usurf'
*
 label(215.0,17.0,"GlobCurrent Surface (0m) Current (nov1999-oct2009) CI=0.1",30,0,0.14)
*'draw string 8.0 1.25 [cm]'
'run cbarn2.gs 0.85 0 4.25 6.0 1 2'
'close 1'
*----------------------------------------------------
'open jra55_v1_3_un10m_TL319.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
'set parea 1.00 8.00 6.50 10.5'
*
...
'set lat -10 16'
*
'define jra55doave=ave(un10m.1,time=nov1999,time=oct2006)'
*
'close 1'
*----------------------------------------------------
'open un10m.v1_2tq.nov1999_oct2009.anncl.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
'set cthick 2'
'd jra55doave-u10m'
 label(215.0,17.0,"JRA55-do - JRA55-raw (CI=0.1)",30,0,0.14)
'set strsiz 0.08'
'draw string 7.5 0.5 [m/s]'
'set strsiz 0.1'
'run cbarn2.gs 0.85 0 4.25 0.75 1 2'
*----------------------------------------------------
'close 1'
*
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o un10m_surfcurrent.eps'
'!rm -f hflux.gm'
*====================================================
