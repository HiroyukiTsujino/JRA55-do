...
'reinit'
*-----------------------------------
'open u10m.v1_3.nov1999_oct2009.anncl.ctl'
'open usurf_globcurrent_nov1999-oct2009.ctl'
*
...
*
'set gxout shaded'
'run colmap.gs odcm40'
'run clevsreg.gs -4.4 3.4 0.2'
'set grads off'
'd u10m'
*
'set gxout contour'
'set ccolor 15'
'set clab off'
'set clevs -0.5 -0.2 0.2 0.5'
'set cthick 1'
'd usurf.2'
 label(138.0,41.5,"(a) JRA55-do Ua and GlobCurr Uo (nov99-oct09)",30,0,0.10)
'run cbarn2.gs 0.5 0 2.25 5.5 2 5'
*
*'draw string 8.0 1.25 [cm]'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 4.7 8.2 6.0 10.0'
*
'set lon 275 315'
'set lat 25 42'
'set xlint 5'
...
'set cthick 1'
'd usurf.2'
 label(295.0,43.5,"(c) JRA55-do Ua and GlobCurr Uo (nov99-oct09)",30,0,0.10)
*
'run cbarn2.gs 0.5 0 6.5 5.5 4 5'
'close 2'
'close 1'
*-----------------------------------
'open v10m.v1_3.nov1999_oct2009.anncl.ctl'
'open vsurf_globcurrent_nov1999-oct2009.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 0.5 4.0 0.75 4.75'
*
'set lon 120 155'
'set lat 23 40'
'set xlint 5'
...
'set cthick 1'
'd vsurf.2'
 label(138.0,41.5,"(b) JRA55-do Va and GlobCurr Vo (nov99-oct09)",30,0,0.10)
'run cbarn2.gs 0.5 0 2.25 0.25 2 5'
*
*'draw string 8.0 1.25 [cm]'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 4.7 8.2 0.75 4.75'
*
'set lon 275 315'
'set lat 25 42'
'set xlint 5'
...
'set cthick 1'
'd vsurf.2'
 label(295.0,43.5,"(d) JRA55-do Va and GlobCurr Vo (nov99-oct09)",30,0,0.10)
*
'run cbarn2.gs 0.5 0 6.5 0.25 4 5'
'close 2'
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o jra55wind_globcur.eps'
'!rm -f hflux.gm'
'printim jra55wind_globcur.png white'
*====================================================
