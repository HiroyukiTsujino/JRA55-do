...
'reinit'
*-----------------------------------
'open wind_mag_offset_annual.1999_2015.ctl'
*
...
'd windcorr'
*
 label(215.0,17.0,"Wind speed correction for (nov1999-oct2009) CI=0.5",30,0,0.14)
...
'set cthick 2'
'd jra55doave-u10m'
 label(215.0,17.0,"JRA55-do - JRA55-raw (CI=0.5)",30,0,0.14)
'set strsiz 0.08'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o un10m_diff.eps'
'!rm -f hflux.gm'
*====================================================
