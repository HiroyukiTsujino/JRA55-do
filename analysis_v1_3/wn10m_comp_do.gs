...
'reinit'
*-----------------------------------
'open jra55_v1_3_wn10m_TL319.ctl'
*
...
'set gxout shaded'
'run colmap.gs odcm2'
'run clevsreg.gs 4 8.75 0.25'
'set grads off'
'd ave(wn10m.1,time=nov1999,time=oct2009)'
*
'set gxout contour'
'set ccolor 1'
'set clab on'
...
'set cthick 2'
'd ave(wn10m.1,time=nov1999,time=oct2009)'
 label(215.0,17.0,"Wind speed JRA55-do (nov1999-oct2009) CI=0.5",30,0,0.14)
*'draw string 8.0 1.25 [cm]'
'run cbarn2.gs 0.85 0 4.25 6.0 0 2'
'close 1'
*----------------------------------------------------
...
'run clevsreg.gs 4 8.75 0.25'
'set grads off'
'd ave(swind,time=nov1999,time=oct2009)'
*
'set gxout contour'
'set ccolor 1'
'set clab on'
...
'set cthick 2'
'd ave(swind,time=nov1999,time=oct2009)'
 label(215.0,17.0,"QuikSCAT (nov1999-oct2009) CI=0.5",30,0,0.14)
'set strsiz 0.08'
'draw string 7.5 0.5 [m/s]'
'set strsiz 0.1'
'run cbarn2.gs 0.85 0 4.25 0.75 0 2'
*----------------------------------------------------
'close 1'
*
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o wn10m_jra55do.eps'
'!rm -f hflux.gm'
*====================================================
