...
'reinit'
*-----------------------------------
'open jra55_v1_3_tauy.ctl'
'open core_aug2017_tauy.ctl'
...
'set gxout shaded'
'run colmap.gs rbb64'
'run clevsreg.gs -0.155 0.155 0.005'
'set grads off'
'd ave(tauy.1,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'set cthick 2'
'd ave(tauy.1,time=jan1988,time=jan2007)'
 label(205.0,98.0,"Meridional wind stress JRA55-do (1988-2007) CI=0.05",30,0,0.15)
...
'set gxout shaded'
'run colmap.gs rb26'
'run clevsreg.gs -0.06 0.06 0.005'
'set grads off'
'd ave(tauy.1-tauy.2,time=jan1988,time=jan2007)'
*
'set gxout fgrid'
'set fgvals 0 15'
'd index.3'
...
'set cthick 2'
'd ave(tauy.1-tauy.2,time=jan1988,time=jan2007)'
 label(205.0,98.0,"JRA55-do - CORE (1988-2007) CI=0.01",30,0,0.15)
'set strsiz 0.08'
'draw string 7.5 0.5 [N/m2]'
'set strsiz 0.1'
...
'print'
'disable print'
'!gxeps -c -i hflux.gm -o tauy_diff.eps'
'!rm -f hflux.gm'
*====================================================
