...
flin="${orgdir}/tauy."
flout="${newdir}/tauy.JRA55v0_1.nc"
flctl="${newdir}/tauy.JRA55v0_1.ctl"
...
&nml_vars
 ...
 vname_tmp='tauvo'
 vunit_tmp='N/m2',
 vlongname_tmp='Surface Downward Y Stress'
 vstandardname_tmp='surface_downward_y_stress'
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Surface Downward Northward Stress based on the unadjusted atmospheric state of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.1"
  global_attributes%comment="Stress is estimated using the bulk formula of Large and Yeager (2009)"
