...
flin="${orgdir}/tauy."
flout="${newdir}/tauy.JRA55v0_3.nc"
flctl="${newdir}/tauy.JRA55v0_3.ctl"
...
&nml_global_attributes
  global_attributes%title="Surface Downward Northward Stress based on an adjusted atmospheric state of JRA-55"
