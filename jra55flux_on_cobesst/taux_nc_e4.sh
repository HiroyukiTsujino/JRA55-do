...
flin="${orgdir}/taux."
flout="${newdir}/taux.JRA55v0_3.nc"
flctl="${newdir}/taux.JRA55v0_3.ctl"
...
&nml_global_attributes
  global_attributes%title="Surface Downward Eastward Stress based on an adjusted atmospheric state of JRA-55"
