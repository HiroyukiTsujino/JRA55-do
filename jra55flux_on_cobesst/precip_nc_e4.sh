...
flin="${orgdir}/precip."
flout="${newdir}/precip.JRA55v0_3.nc"
flctl="${newdir}/precip.JRA55v0_3.ctl"
...
&nml_global_attributes
  ...
  global_attributes%comment="CORE interannual forcing version 2 (Large and Yeager 2009) is used adjust JRA-55"
