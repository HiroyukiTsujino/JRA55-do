...
'reinit'
*------------------------------------------------
'open evapor_med_v0_1.ctl'
'open evapor_med_v0_7_2.ctl'
'open evapor_med_core_dec2015.ctl'
*
'open precip_med_v0_1.ctl'
'open precip_med_v0_7_2.ctl'
'open precip_med_core_dec2015.ctl'
*
...
'd f.6*3.179e3'
*
label(34,0.22,"Evap (solid line) Precip (dashed line) over Mediterranean",30,0,0.12)
label(-6,0.1,"10^9 [kg/sec]",4,90,0.12)
...
'd (f.3-f.6)*3.179e3'
*
label(34,0.16,"E-P",30,0,0.12)
*label(-5,0,"[Sv]",4,90,0.12)
label(-6,0.04,"10^9 [kg/sec]",4,90,0.12)
label(34,-0.08,"[Year]",30,0,0.12)
splt(0.0,1,68)
*
*'close 7'
'close 6'
...
'print'
'disable print'
'!gxeps -c -i waterflux.gm -o waterflux_jra55_v0_7_2_med.eps'
*====================================================
