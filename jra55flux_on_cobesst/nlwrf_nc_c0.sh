...
flin="${orgdir}/nlwrf."
flout="${newdir}/nlwrf.JRA55v0_1.nc"
flctl="${newdir}/nlwrf.JRA55v0_1.ctl"
...
&nml_global_attributes
  global_attributes%title="Unadjusted surface net longwave radiation of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.1"
  global_attributes%comment="COBESST is used to estimate upward black body radiation"
