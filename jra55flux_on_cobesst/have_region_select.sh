...
if [ x${2} = x ]; then
  ...
  echo "  item = nswrf nlwrf latent sensible evapor precip dswrf_all dlwrf_all"
  echo "  region_number = 1-22 (except for 10)"
  exit
fi
...
#file_in_base=../linkdir/forcing/jra55fcst_annual_1x1       # raw v1.0
#vername=raw-v1_0

#file_in_base=../linkdir/forcing/jra55fcst_v1_1_annual_1x1  # do v1.1
#vername=do-v1_1

#file_in_base=../linkdir/forcing/jra55fcst_v1_2_annual_1x1  # do v1.2
#vername=do-v1_2

#file_in_base=../linkdir/forcing/jra55fcst_v1_3_annual_1x1  # do v1.3
#vername=do-v1_3
...
fileo=${item}-${vername}-${file_region[${region_number}]}
filectl=${item}-${vername}-${file_region[${region_number}]}.ctl
