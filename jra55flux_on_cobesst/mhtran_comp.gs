...
label(0.0,3.2,"GLOBAL MHT (1988-2007)",30,0,0.12)
label(-110,0.0,"[PW]",4,90,0.10)
label(0.0,-3.4,"latitude",30,0,0.12)
*
splt(0.0,0,180)
*---------------------------------------------------------------
'set vpage 0.0 11.0 0.0 8.5'
'set parea 4.1 7.2 1.0 8.0'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.10'
'set ylopts 1 3 0.12'
...
label(0.0,3.2,"Indo-Pacific MHT (1988-2007)",30,0,0.12)
label(-110,0.0,"[PW]",4,90,0.10)
label(0.0,-3.4,"latitude",30,0,0.12)
*
splt(0.0,0,180)
...
label(0.0,3.2,"Arctic-Atlantic MHT (1988-2007)",30,0,0.12)
label(-110,0.0,"[PW]",4,90,0.10)
label(0.0,-3.4,"latitude",30,0,0.12)
*
splt(0.0,0,180)
...
'print'
'disable print'
'!gxeps -c -i dswrf.gm -o mht_comp.eps'
'!rm dswrf.gm'
*==============================================================
