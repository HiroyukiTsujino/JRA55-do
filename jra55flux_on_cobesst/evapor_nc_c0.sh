...
flin="${orgdir}/evapor."
flout="${newdir}/evapor.JRA55v0_1.nc"
flctl="${newdir}/evapor.JRA55v0_1.ctl"
...
&nml_global_attributes
  global_attributes%title="Evaporation flux based on the unadjusted atmospheric state of JRA-55"
