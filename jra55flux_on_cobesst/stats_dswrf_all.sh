...
#file_base=${basedir}/jra55fcst_annual_1x1/dswrf_all.
#fileo=wvn10m_glb_v0_1

# jra55-do-v1.1

file_base=${basedir}/jra55fcst_v1_1_annual_1x1/dswrf_all.
rmiss_in=9.999e20
fileo=${basedir}/jra55fcst_v1_1_annual_1x1/dswrf_all_stats.${year_st}-${year_ed}.gd
rmiss_out=9.999e20
