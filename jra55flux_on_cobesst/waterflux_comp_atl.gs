...
'reinit'
*------------------------------------------------
'open precip_arctic_v0_7_2.ctl'
'open precip_arctic_core_1x1.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'
'set parea 1.5 8.0 7.8 10.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.2*3.179e3'
*
label(34,0.062,"Precip over Arctic",30,0,0.12)
label(-6,0.05,"10^9 [kg/sec]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*
'close 2'
'close 1'
*--------------------------------------------------------
'open precip_subpolatl_v0_7_2.ctl'
'open precip_subpolatl_core_1x1.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'

'set parea 1.5 8.0 4.3 7.0'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.2*3.179e3'
*
label(34,0.117,"Precip over North Atlantic subpolar gyre",30,0,0.12)
label(-6,0.100,"10^9 [kg/sec]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*
'close 2'
'close 1'
*--------------------------------------------------------
'open precip_subarcatl_v0_7_2.ctl'
'open precip_subarcatl_core_1x1.ctl'
*
'set vpage 0.0 8.5 0.0 11.0'

'set parea 1.5 8.0 0.8 3.5'
'set gxout line'
'set grads off'
'set xlopts 1 3 0.12'
'set ylopts 1 3 0.12'
...
'd f.2*3.179e3'
*
label(34,0.152,"Precip over North Atlantic northern subtropical gyre",30,0,0.12)
label(-6,0.130,"10^9 [kg/sec]",4,90,0.12)
*label(28,-25,"[Year]",30,0,0.12)
*
'close 2'
'close 1'
...
'print'
'disable print'
'!gxeps -c -i waterflux.gm -o waterflux_jra55_atl.eps'
*====================================================
