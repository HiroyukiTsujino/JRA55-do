...
flin="${orgdir}/nswrf."
flout="${newdir}/nswrf.JRA55v0_1.nc"
flctl="${newdir}/nswrf.JRA55v0_1.ctl"
...
&nml_global_attributes
  global_attributes%title="Unadjusted surface net shortwave radiation of JRA-55"
  global_attributes%institution="JMA Meteorological Research Institute"
  global_attributes%version="v0.1"
  global_attributes%comment="Albedo formula of Large and Yeager (2009) is used to estimate upward radiation"
