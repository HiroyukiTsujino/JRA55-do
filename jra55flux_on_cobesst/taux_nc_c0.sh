...
flin="${orgdir}/taux."
flout="${newdir}/taux.JRA55v0_1.nc"
flctl="${newdir}/taux.JRA55v0_1.ctl"
...
&nml_vars
 ...
 vname_tmp='tauuo'
 vunit_tmp='N/m2',
 vlongname_tmp='Surface Downward X Stress'
 vstandardname_tmp='surface_downward_x_stress'
 rconv_tmp=1.0,
 rmin_tmp=-9.99e33,
 rmax_tmp=9.99e33,
...
&nml_global_attributes
  global_attributes%title="Surface Downward Eastward Stress based on the unadjusted atmospheric state of JRA-55"
