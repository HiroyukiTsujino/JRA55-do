...
flout="${newdir}/sensible.JRA55v0_1.nc"
flctl="${newdir}/sensible.JRA55v0_1.ctl"
...
&nml_global_attributes
  global_attributes%title="Sensible heat flux based on the unadjusted atmospheric state of JRA-55"
