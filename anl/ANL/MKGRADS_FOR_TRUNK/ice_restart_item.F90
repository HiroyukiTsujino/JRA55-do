...
!         <-  9  -><3><----  
  character(len=256) :: varname(nitems) = (/ &
       ...
       & "t0         0 99 Sea Surface skin tempareture below ice [degC]                                        ", &
       & "t0l        0 99 Sea Surface skin tempareture of open water [degC]                                    ", &
       & "ts         0 99 Surface Temperature of sea ice [degC]                                                ", &
