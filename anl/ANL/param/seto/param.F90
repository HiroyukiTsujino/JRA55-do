...
module oc_mod_param   !J  cgs単位系
  ...
  character(len=max_char_len),save :: name_model = 'SETO'
  !
  !J     定数の定義
  !
  ...
  !
  !
  integer(4), parameter:: IMUT = 301   !J  格子点数
  integer(4), parameter:: JMUT = 364
...
#endif /* ! OGCM_BBL */
  !
  real(8), parameter:: SLAT0 = 28.d0  !J  海域の南端緯度
  real(8), parameter:: SLON0 = 129.d0  !J  海域の東端経度
  !
...
!!!!!#endif /* OGCM_CLMFRC */
  ...
  !
  integer(4), parameter:: NPARTX = 1  !J  経度方向分割数
  integer(4), parameter:: NPARTY = 8  !J  緯度方向分割数
