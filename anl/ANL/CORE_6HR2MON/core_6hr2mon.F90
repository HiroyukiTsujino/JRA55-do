...
program core_6hr2mon
  ...
  !
  namelist /nml_core_6hr2mon/ x_num, y_num, z_num, var_num, undef, &
  ...
  !==========================================
  !
  read(unit=5, nml=nml_core_6hr2mon)
  print *,'x_num    :', x_num
  print *,'y_num    :', y_num
  print *,'z_num    :', z_num
