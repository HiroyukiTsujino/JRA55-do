...
!====================================================
!
! Calculate Northward Heat Transport
!
!====================================================
program nward_heat_transport
  !
  ...
  implicit none
  !
  real(8), parameter :: unitcnv = cp * ro * 1.d-7 ! [K cm^3 / s] -> [W]
  !
  ! 地理座標パラメタ
  ! 
...
#endif /* OGCM_VARIABLE */
  !
  namelist /nml_nht/   flin_ut, flin_vt,                        &
...
!
!====================================================
end program nward_heat_transport
