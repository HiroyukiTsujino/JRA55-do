...
module diff_mean_test
  ...
  character(*),parameter,public :: testname='diff_mean'
  public :: ini_test
  public :: test_calc
...
subroutine test_calc
  ...
  namelist /diff_mean_calc/ rval, rrange, nx, ny, nz

  call libmxe_ut__clear
  call libmxe_ut__open_namelist( lun )
    read(lun,nml=diff_mean_calc,iostat=i)
  close(lun)
  if ( i/=0 ) return
