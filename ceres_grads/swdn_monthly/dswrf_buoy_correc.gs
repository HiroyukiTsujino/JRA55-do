...
'd ave(swdn,time=mar2000,time=feb2015)'
'set strsiz 0.08'
'run correc_of_swdn_reversed.gs'
*'draw string 8.0 1.25 [cm]'
 label(210.0,55.0,"Bias of CERES downward SW in percent",30,0,0.15)
...
'print'
'disable print'
'!gxeps -c -i ceres_swdn.gm -o ceres_swdn_correc.eps'
'!rm ceres_swdn.gm'
*====================================================
