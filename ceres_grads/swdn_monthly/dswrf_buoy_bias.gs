...
*
*'set gxout shaded'
*'run colmap_kuragano.gs rnbw'
*'run clevsreg.gs 90 280 10'
*'set grads off'
'set gxout contour'
'set clevs 0.0'
'set grads off'
'd ave(swdn,time=mar2000,time=feb2015)'
'set strsiz 0.075'
'run bias_of_swdn_fixed.gs'
*'draw string 8.0 1.25 [cm]'
 label(210.0,55.0,"CERES downward SW and Bias from buoy (annual mean)",30,0,0.15)
'run cbarn2.gs 0.8 0 5.25 0.5 1 2'
'close 1'
*----------------------------------------------------
'enable print ceres_swdn.gm'
'print'
'disable print'
'!gxeps -c -i ceres_swdn.gm -o ceres_swdn_bias.eps'
'!rm ceres_swdn.gm'
*====================================================
