...
'set cmark 9'
'set cmark 0'
'd (swdn_ceres-swdn_sta)/swdn_ceres*100'
splt(0.0,1,12)
*
label(6.5,25,"SYO (69S, 39.58E)",30,0,0.12)
label(-0.3,0,"[%]",4,90,0.11)
...
splt(0.0,1,12)
*
label(6.5,25,"GVN (70.65S, 351.75E)",30,0,0.12)
label(-0.3,0,"[%]",4,90,0.11)
*label(6.5,-15,"[month]",6,0,0.12)
*
'close 1'
...
splt(0.0,1,12)
*
label(6.5,25,"NYA (78.93N, 11.93E)",30,0,0.12)
label(-0.3,0,"[%]",4,90,0.11)
*label(6.5,-15,"[month]",6,0,0.12)
*
'close 1'
...
splt(0.0,1,12)
*
label(6.5,25,"ALE (82.45N, 297.49E)",30,0,0.12)
label(-0.3,0,"[%]",4,90,0.11)
*label(6.5,-15,"[month]",6,0,0.12)
*
'close 1'
...
splt(0.0,1,12)
*
label(6.5,25,"BAR (71.32N, 203.39E)",30,0,0.12)
label(-0.3,0,"[%]",4,90,0.11)
*label(6.5,-15,"[month]",6,0,0.12)
*
'close 1'
...
splt(0.0,1,12)
*
label(6.5,25,"TIK (71.59N, 128.92E)",30,0,0.12)
label(-0.3,0,"[%]",4,90,0.11)
*label(6.5,-15,"[month]",6,0,0.12)
*
'close 1'
...
'print'
'disable print'
'!gxeps -c -i swdn_comp.gm -o lwdn_comp_ratio.eps'
'!\rm swdn_comp.gm'
*====================================================
