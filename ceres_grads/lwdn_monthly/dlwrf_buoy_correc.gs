...
*'run clevsreg.gs 110 500 10'
*'set grads off'
*'d ave(lwdn,time=mar2000,time=feb2015)'
'set gxout contour'
'set clevs 0.0'
'set grads off'
'd ave(lwdn,time=mar2000,time=feb2015)'
*
'set strsiz 0.09'
'run correc_of_lwdn_reversed_all.gs'
*'draw string 8.0 1.25 [cm]'
 label(210.0,55.0,"Bias of CERES downward LW in percent",30,0,0.15)
'run cbarn2.gs 0.8 0 5.25 0.5 1 2'
'close 1'
*----------------------------------------------------
'enable print ceres_lwdn.gm'
'print'
'disable print'
'!gxeps -c -i ceres_lwdn.gm -o ceres_lwdn_correc.eps'
'!rm ceres_lwdn.gm'
*====================================================
