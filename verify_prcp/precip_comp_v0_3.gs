...
'reinit'
*------------------------------------------------
'open precip_zm_jra55_c0.ctl'
'open precip_zm_core.ctl'
'open precip_zm_jra55_e4.ctl'
*
...
'set cthick 5'
'set cmark 0'
'd ave(f.1,time=jan1979,time=dec2008) * 86400'
'set ccolor 3'
'set cthick 5'
'set cmark 0'
'd ave(f.2,time=jan1979,time=dec2008) * 86400 * 10 * 1.036'
'set ccolor 4'
'set cthick 5'
'set cmark 0'
'd ave(f.3,time=jan1979,time=dec2008) * 86400'
label(0,11.5,"Precipitation (1979-2008)",30,0,0.12)
...
'print'
'disable print'
'!gxeps -c -i precip_comp.gm -o precip_comp_v0_3.eps'
'!rm precip_comp.gm'
*====================================================
