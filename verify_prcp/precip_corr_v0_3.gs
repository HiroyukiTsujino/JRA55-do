...
*'d ave(tpratcorr,t=1,t=12)'
*
label(215.0,98.0,"(a) Preciptation multiplicative factor (v0_2)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
*
'close 1'
*----------------------------------------------------
'open prcp_corr_latlon.1979_2008.ctl'
*
'set vpage 0.00 8.50 0.00 11.00'
...
*'d ave(tpratcorr,t=1,t=12)'
*
label(215.0,98.0,"(b)  Preciptation multiplicative factor (v0_3)",30,0,0.15)
*'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
*
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i precip_comp.gm -o precip_corr_v0_3.eps'
'!rm precip_comp.gm'
*====================================================
