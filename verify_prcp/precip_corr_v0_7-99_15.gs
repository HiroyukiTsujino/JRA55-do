...
*'d ave(tpratcorr,t=1,t=12)'
*
label(215.0,98.0,"(c) Preciptation multiplicative factor (v0.8 1999-2015)",50,0,0.14)
...
'print'
'disable print'
'!gxeps -c -i precip_comp.gm -o precip_corr_v0_7-99_15.eps'
'!rm precip_comp.gm'
*====================================================
