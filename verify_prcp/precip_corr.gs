...
'd ave(tpratcorr,t=1,t=12)'
*
label(240.0,98.0,"(a) Preciptation multiplicative factor (annual mean)",30,0,0.15)
...
'd ave(tpratcorr,t=1,t=12)'
*
label(240.0,98.0,"(b) smoothed factor (annual mean)",30,0,0.15)
'run cbarn2.gs 0.8 0 4.25 0.5 1 2'
*
'close 1'
*----------------------------------------------------
...
'print'
'disable print'
'!gxeps -c -i precip_comp.gm -o precip_corr.eps'
'!rm precip_comp.gm'
*====================================================
