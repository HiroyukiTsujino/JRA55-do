...
idir=/denkei-shared/og1/htsujino/SURF_FLUX/forcing/jra_for_mricom_v1_3/TL319_grid
odir=/denkei-shared/og1/htsujino/SURF_FLUX/forcing/jra_for_mricom_v1_3_filled/TL319_grid
...
#      for var in prcp
#      for var in slprs
#      for var in dswrf dlwrf prcp slprs sph10m tmp10m u10m v10m
      for var in dswrf dlwrf prcp sph10m tmp10m u10m v10m
      do
