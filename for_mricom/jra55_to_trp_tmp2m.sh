...
do
  ...
  flin="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/TL319_grid/${year}/tmp2m.${year}010100"
  flout="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/tripolar-1_0-0_5/${year}/tmp2m.${year}010100"
  ./map_scalar.sh ${flin} ${flout} t 1 1 1 1 1 1 1 1 ${undef} .true. .false. ${ftable} ${farea}

  flin="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/TL319_grid/${year}/tmp2m.${year}010103"
  flout="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/tripolar-1_0-0_5/${year}/tmp2m.${year}010103"
  ./map_scalar.sh ${flin} ${flout} t 1 1 1 1 1 1 1 1 ${undef} .true. .false. ${ftable} ${farea}

  flin="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/TL319_grid/${year}/tmp2m.${year}123121"
  flout="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/tripolar-1_0-0_5/${year}/tmp2m.${year}123121"
  ./map_scalar.sh ${flin} ${flout} t 1 1 1 1 1 1 1 1 ${undef} .true. .false. ${ftable} ${farea}
