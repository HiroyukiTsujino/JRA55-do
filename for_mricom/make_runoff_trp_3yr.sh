...
do
  ...
  flinb="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/tripolar-1_0-0_5/runoff/${item}.${yearb}.dat"
  flinm="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/tripolar-1_0-0_5/runoff/${item}.${year}.dat"
  flinn="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/tripolar-1_0-0_5/runoff/${item}.${yearn}.dat"
