...
do
  ...
  flin="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/TL319_grid_v2/${year}/tmp2m.${year}"
  flout="/worke/htsujino/SURF_FLUX/forcing/jra_for_mricom/tripolar-1_0-0_5-v2/${year}/tmp2m.${year}"
