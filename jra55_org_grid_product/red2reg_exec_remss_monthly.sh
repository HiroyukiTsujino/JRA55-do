...
do
  ...
  do
    ...
    for item in swind_neutral
    do

      fcst_org='/work115/htsujino/SURF_FLUX/forcing/jra_remss_monthly_org'
      fcst_latlon='/work115/htsujino/SURF_FLUX/forcing/jra_remss_monthly_latlon'
