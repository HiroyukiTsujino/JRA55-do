...
if [ x${2} = x ]; then
  echo "Usage: red2reg_exec_wind_monthly.sh start_year end_year (start_month end_month)"
  exit
fi
...
# JRA-55 fcst
orgdir=../linkdir/forcing/jra_monthly_org_e1
latlondir=../linkdir/forcing/jra_monthly_latlon_e1
...
# JRA-55C
#orgdir=../linkdir/forcing/jra55c_monthly_org_filt
#latlondir=../linkdir/forcing/jra55c_monthly_latlon_filt
