...
'd index.2'
*
label(240.0,98.0,"Availability of QSCAT wind on JRA-55 grid",70,0,0.14)
*'run cbarn2.gs 0.8 0 4.25 0.5 2 4'
*
'close 2'
'close 1'
*-------------------------------------------------------------
'open jra55_wind_fill.ctl'
'open jra55_ocean_mask.ctl'
*
...
'd index.2'
*
label(240.0,98.0,"Availability of wind adjustment factor on JRA-55 grid",70,0,0.14)
*
'close 2'
'close 1'
*----------------------------------------------------
'enable print jra_qscat_mask.gm'
'print'
'disable print'
'!gxeps -c -i jra_qscat_mask.gm -o jra_qscat_mask.eps'
*====================================================
