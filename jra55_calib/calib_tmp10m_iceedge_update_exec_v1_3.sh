...
orgdir=../linkdir/work/jra55fcst_v1_3_prod1_3hr_TL319
newdir=../linkdir/work/jra55fcst_v1_3_prod2_3hr_TL319
...
sed -e s%@yrst@%${yrst}% \
    ...
    -e s%@mned@%${mned}% \
    -e s%@dyed@%${dyed}% \
    namelist.calibtmp10m_iceedge_update_v1_3_template > namelist.calibtmp10m_iceedge
