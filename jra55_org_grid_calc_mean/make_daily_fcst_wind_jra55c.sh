...
daily_dir='../linkdir/forcing/jra55c_daily_org_filt'
latlon_dir='../linkdir/forcing/jra55c_daily_latlon_filt'
...
do
  ...
  do
    ...
    sed -e s/@year@/${yr}/ \
        -e s/@month@/${mn}/ \
        -e s/@day@/${dy}/ \
	namelist.make_daily_jra55c_fcst_surf_filt_template > namelist.make_daily_surf
