...
daily_dir='../linkdir/forcing/jra55anl_filt_erai_daily_TL319r'
latlon_dir='../linkdir/forcing/jra55anl_filt_erai_daily_TL319'
...
do
  ...
  do
    ...
    sed -e s/@year@/${yr}/ \
        -e s/@month@/${mn}/ \
        -e s/@day@/${dy}/ \
	namelist.make_daily_anl_erai_wind_template > namelist.make_daily_surf
