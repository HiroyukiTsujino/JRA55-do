...
daily_dir='../linkdir/forcing/jra_anl_daily_org'
latlon_dir='../linkdir/forcing/jra_anl_daily_latlon'
...
do
  ...
  do
    ...
    sed -e s/@year@/${yr}/ \
        -e s/@month@/${mn}/ \
        -e s/@day@/${dy}/ \
	namelist.make_daily_anl_surf_template > namelist.make_daily_surf
