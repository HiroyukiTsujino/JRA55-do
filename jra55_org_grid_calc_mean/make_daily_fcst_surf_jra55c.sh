...
daily_dir='../linkdir/forcing/jra55c_daily_org'
latlon_dir='../linkdir/forcing/jra55c_daily_latlon'
...
do
  ...
  do
    ...
    sed -e s/@year@/${yr}/ \
        ...
        -e s/@ice_chk@/${ice_chk}/ \
	namelist.make_daily_jra55c_fcst_surf_template > namelist.make_daily_surf
