...
program read_netcdf_output_grads
  ...
  namelist /nml_srb3_0lp_net_ocn/ &
       & flnin1_base, undef_in1, &
       & flnin2_base, undef_in2, &
       & flnin3_base, undef_in3, &
       & flnot1_base, flnot2_base, undef_out

  open (11,file='namelist.srb3_0lp_net_ocn')
  read (11,nml=nml_srb3_0lp_net_ocn)
  close(11)
  ...
  do nyear = 1983, 2007
    ...
    do m = mst, med
      ...
      sta(1) = nf_inq_varid(ifiles(1),'sw_sfc_net',var(1))
      sta(2) = nf_inq_varid(ifiles(2),'lw_sfc_net',var(2))
