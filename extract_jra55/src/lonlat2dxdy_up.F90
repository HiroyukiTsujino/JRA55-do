...
program lonlat_to_dxdy_up
  ...
  open(lun,file='namelist.lonlat2dxdy_up')
  ...
  write(6,'(7f12.6)') (alont(i),i=1,imut)
  write(6,'(7f12.6)') (alatt(j),j=1,jmut)

  write(6,'(7f12.6)') (dxtdeg(i),i=1,jmut)
  write(6,'(7f12.6)') (dytdeg(j),j=1,jmut)

  file_dxdy='dxdy_jra55_up.d'
